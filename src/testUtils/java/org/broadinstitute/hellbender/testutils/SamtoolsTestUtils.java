...
public class SamtoolsTestUtils {
    ...
    public static String getSamtoolsBin() {
        ...
        // try the locations used on the CI docker, the GATK docker, and local homebrew installs
        return samtoolsPath != null ?
                samtoolsPath :
                Files.exists(Paths.get("/opt/homebrew/bin/samtools")) ?
                        "/opt/homebrew/bin/samtools" : // homebrew installs
                        "/usr/bin/samtools";            // make install target
    }
