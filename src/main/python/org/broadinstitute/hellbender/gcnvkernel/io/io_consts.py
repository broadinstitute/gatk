...
# column name for denoised copy-number file
denoised_copy_number_column_name = "DENOISED_COUNT"
...
default_denoised_copy_numbers_tsv_filename = "denoised_counts.tsv"
