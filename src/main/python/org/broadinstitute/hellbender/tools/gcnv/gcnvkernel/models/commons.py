...
def poisson_logp(mu, value):
    """Generates symbolic poisson logp.

    Args:
        mu: poisson parameter tensor
        value: poisson counts

    Note:
        `mu` and `value` must be either shape-compatible or be commensurately broadcastable.

    Returns:
        symbolic poisson logp
    """
