...
def get_args():
    ...
    parser.add_argument('--vcf-file', required=True, help='An input VCF file')
    parser.add_argument('--truth-vcf', required=True, help="A validated version of the input VCF file")
    parser.add_argument('--ref-file', required=True, help='Reference sequence file for the VCF')
    parser.add_argument('--input-file', help='BAM file containing reads from which the VCF is derived. Only required for the 2D model')
