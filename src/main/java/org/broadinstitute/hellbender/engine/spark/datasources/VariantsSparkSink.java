...
public final class VariantsSparkSink {
    ...
    private static void writeVariantsSingle(
        ...
        if (writeGvcf) {
            ...
            variantsToSave = sortedVariants.mapPartitions((FlatMapFunction<Iterator<VariantContext>, VariantContext>) v -> new GVCFBlockMergingIterator(v, gqPartitions, defaultPloidy));
        } else {
