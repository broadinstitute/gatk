...
interface LocatableCacheStrategy<CACHED_FEATURE extends Locatable> {
     ...
     */
    Locatable getCacheIntervalFromQueryInterval(final Locatable queryInterval);
     ...
     */
    List<CACHED_FEATURE> queryCache(final Deque<CACHED_FEATURE> cache, final Locatable queryInterval);
     ...
     */
    Iterator<CACHED_FEATURE> refillCache(final Locatable queryInterval);
     ...
     */
    Locatable trimCache(final Deque<CACHED_FEATURE> cache, final Locatable cachedInterval, final Locatable newInterval);
}