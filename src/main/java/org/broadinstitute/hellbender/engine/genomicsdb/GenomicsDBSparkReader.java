...
@CommandLineProgramProperties(
  summary = "Read variants into Spark RDDs from GenomicsDB.",
  oneLineSummary = "Read variants into Spark RDDs from GenomicsDB",
  programGroup = GenomicsDBProgramGroup.class
)

public class GenomicsDBSparkReader extends GATKTool {
  /**
