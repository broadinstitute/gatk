...
/**
 * KeyVariantByVariantShard takes a PCollection of variants and keys each read by the variants shards it overlaps.
 * Note that if a variant span several shards multiple KVs will be produced. This part of the larger transform to join
