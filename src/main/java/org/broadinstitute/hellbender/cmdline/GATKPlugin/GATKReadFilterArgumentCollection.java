...
/**
 * An abstract ArgumentCollection for defining the set of read filterSuffix descriptor plugin arguments that are exposed to the user on the command line.
 *
...
public abstract class GATKReadFilterArgumentCollection implements Serializable {
    ...
    /**
     * Returns the enabled filterSuffix names. Order should be honored.
     */
    public abstract List<String> getUserEnabledReadFilterNames();

    /**
     * Returns the disabled read filterSuffix names. Order should be honored.
     */
