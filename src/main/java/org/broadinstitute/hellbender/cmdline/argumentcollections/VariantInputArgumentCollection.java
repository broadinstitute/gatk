...
/**
 * An abstract argument collection for use with tools that accept input files containing variants
 * (eg., VCF/GVCF files).
 */
public abstract class VariantInputArgumentCollection implements Serializable {
