...
public class ComposeSTRTableFile extends GATKTool {
                                  ...
                                  final STRDecimationTable decimationTable, final STRTableFileBuilder output)
    {
        ...
        while (pos <= seqEnd) {
           ...
           final BestPeriod best = BestPeriod.initializeToOne(beg, end);
    ...
    private void emitOrDecimateSTR(final int seqNumber, final String seqId, final BestPeriod best,
                                   final STRDecimationTable decimationTable, final STRTableFileBuilder output)
    {
    ...
    private static class BestPeriod {
        ...
        BestPeriod(final int period, final long start, final long end) {
            this.start = start;
            this.end = end;
            this.period = period;
        ...
        private static BestPeriod initializeToOne(final long start, final long end) {
            return new BestPeriod(1, start, end);
        }
