...
public class VetBQWriter extends PendingBQWriter{


    public VetBQWriter(BigQueryWriteClient bqWriteClient, String projectId, String datasetName, String tableName) throws Exception {
