...
public class ACSModeledSegmentUtils {
     ...
     *
     * @param acnvModeledSegments segments generated by ACNV.  Never {@code null}
     ...
     */
    public static List<ACSModeledSegment> convertACNVSegmentsToACSSegments(final List<ACNVModeledSegment> acnvModeledSegments, final double divisor, final Genome genome) {
        ParamUtils.isPositive(divisor, "Divisor must be greater than 0.");
        Utils.nonNull(acnvModeledSegments);
        Utils.nonNull(genome);

        return acnvModeledSegments.stream().map(s -> convertACNVSegmentToACSSegment(s, divisor, genome)).collect(Collectors.toList());
    }
     ...
     */
    public static ACSModeledSegment convertACNVSegmentToACSSegment(final ACNVModeledSegment acnvModeledSegment, final double divisor, final Genome genome) {
        ...
        final double widthF = acnvModeledSegment.getMinorAlleleFractionPosteriorSummary().upper() - acnvModeledSegment.getMinorAlleleFractionPosteriorSummary().lower();
