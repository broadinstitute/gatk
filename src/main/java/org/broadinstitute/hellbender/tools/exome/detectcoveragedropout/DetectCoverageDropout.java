...
public final class DetectCoverageDropout extends CommandLineProgram {
    ...
    protected final static String OUTPUT_FILE_SHORT_NAME = "o";
    protected final static String OUTPUT_FILE_LONG_NAME = "outputFile";

    protected final static String SEG_THRESHOLD_SHORT_NAME = "st";
    protected final static String SEG_THRESHOLD_LONG_NAME = "segThreshold";

    protected final static String MIN_WEIGHT_SHORT_NAME = "m";
    protected final static String MIN_WEIGHT_LONG_NAME = "minWeight";

    protected final static String MIN_DIST_SHORT_NAME = "mmd";
    protected final static String MIN_DIST_LONG_NAME = "minMeanDist";

    @Argument(
            doc = "Target file with copy ratio estimates.  Preferably, the *.tn.*.tsv file as generated by RCS.",
    ...
    protected Object doWork() {
        ...
        final TargetCollection<TargetCoverage> targetList;

        try {
            targetList = TargetCoverageUtils.readModeledTargetFileIntoTargetCollection(targetsFile);
