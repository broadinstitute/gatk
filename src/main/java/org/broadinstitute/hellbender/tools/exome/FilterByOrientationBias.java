...
/**
 * <p>Additionally filterSuffix Mutect2 somatic variant calls for sequence context-dependent artifacts, e.g. OxoG or FFPE deamination.</p>
 *
 * <p>
 ...
 * </pre>
 *
 * <p>This produces variant calls filtered with the orientation_bias filterSuffix and a summary oxog_filtered.vcf.gz.summary file.
...
@CommandLineProgramProperties(
        summary = "Filter Mutect2 somatic variant calls using the Orientation Bias Filter.\n" +
                ...
                " - If you do not wish to filterSuffix, you must skip the filterSuffix entirely.  You cannot do a dummy/non-filterSuffix operation with this tool.\n" +
                ...
                " - The Orientation Bias puts a filterSuffix tag in both the genotype (FORMAT) and variant (FILTER) fields.\n" +
                " - In multiallelic sites, only the first alternate allele is used for filtering.\n" +
                " - This filterSuffix should be applied last in any M2 toolchain.\n" +
                " - Common artifacts:\n G/T (OxoG)\n C/T (deamination) ",
