 ...
 *
 *     <dt>CASE mode:</dt>
 *     <dd><p>The tool will be run in CASE mode using the argument {@code run-mode CASE}. The path to a
 ...
 *      in CASE mode is only the "-calls" subdirectory and is organized similarly to the COHORT mode.</p>
 *
