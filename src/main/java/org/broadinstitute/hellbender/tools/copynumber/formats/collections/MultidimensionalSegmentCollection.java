 ...
 */
public final class MultidimensionalSegmentCollection extends AbstractSampleLocatableCollection<SampleLocatableMetadata, MultidimensionalSegment> {
    ...
    private static final BiFunction<DataLine, SampleLocatableMetadata, MultidimensionalSegment> MULTIDIMENSIONAL_SEGMENT_DATA_LINE_TO_RECORD_FUNCTION =
    ...
    public MultidimensionalSegmentCollection(final File inputFile) {
        super(inputFile, MULTIDIMENSIONAL_SEGMENT_DATA_LINE_TO_RECORD_FUNCTION, MULTIDIMENSIONAL_SEGMENT_RECORD_AND_DATA_LINE_BI_CONSUMER);
    }
