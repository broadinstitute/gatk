 ...
 * and allele fraction distribution of each segment. {@link CNVCaller} recovers the distributions from this
 ...
 * copy number 2 events. First, {@link CNVCaller} looks for clusters in the one dimensional copy ratio data by
...
@DocumentedFeature
@BetaFeature
public final class CNVCaller extends CommandLineProgram {
    public enum RunMode {
        COHORT, CASE
    }

    // Arugments given by the user
    private static final String SEGMENT_CALLER_PYTHON_SCRIPT = "segment_caller_cli.py";
    ...
    protected void onStartup() {
        PythonScriptExecutor.checkPythonEnvironmentForPackage("segment_caller");
    }
    ...
    private boolean executeSegmentCaller(final File inFile, boolean loadCR, boolean loadAF, boolean interactive) {
        ...
        return executor.executeScript(
                new Resource(script, CNVCaller.class),
                null,
                arguments);
    }
}
