 ...
 * ending with the extension .gz.  See the documentation for the {@code input} argument for details on enabling
 * streaming of indexed count files from Google Cloud Storage.
 *
 * <h3>Introduction</h3>
 *
