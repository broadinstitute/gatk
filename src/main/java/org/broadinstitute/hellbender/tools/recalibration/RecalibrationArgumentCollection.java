...
public class RecalibrationArgumentCollection implements Cloneable {
     ...
     */
    @Option(fullName = "knownSites", shortName = "knownSites", doc = "VCF file with the set of known polymorphic sites used to exclude regions around known polymorphisms from analysis.", optional = true)
    ...
    @Option(doc = "The output recalibration table file to create", optional = false)
     ...
     */
    @Option(fullName = "list", shortName = "ls", doc = "List the available covariates and exit", optional = true)
     ...
     */
    @Option(fullName = "covariate", shortName = "cov", doc = "One or more covariates to be used in the recalibration. Can be specified multiple times", optional = true)
     ...
     */
    @Option(fullName = "no_standard_covs", shortName = "noStandard", doc = "Do not use the standard set of covariates, but rather just the ones listed using the -cov argument", optional = true)
     ...
     */
    @AdvancedOption
    @Option(fullName = "run_without_dbsnp_potentially_ruining_quality", shortName = "run_without_dbsnp_potentially_ruining_quality", optional = true, doc = "If specified, allows the recalibrator to be used without a dbsnp rod. Very unsafe and for expert users only.")
     ...
     */
    @Option(fullName = "solid_recal_mode", shortName = "sMode", optional = true, doc = "How should we recalibrate solid bases in which the reference was inserted? Options = DO_NOTHING, SET_Q_ZERO, SET_Q_ZERO_BASE_N, or REMOVE_REF_BIAS")
     ...
     */
    @Option(fullName = "solid_nocall_strategy", shortName = "solid_nocall_strategy", doc = "Defines the behavior of the recalibrator when it encounters no calls in the color space. Options = THROW_EXCEPTION, LEAVE_READ_UNRECALIBRATED, or PURGE_READ", optional = true)
     ...
     */
    @Option(fullName = "mismatches_context_size", shortName = "mcs", doc = "Size of the k-mer context to be used for base mismatches", optional = true)
     ...
     */
    @Option(fullName = "indels_context_size", shortName = "ics", doc = "Size of the k-mer context to be used for base insertions and deletions", optional = true)
     ...
     */
    @Option(fullName = "maximum_cycle_value", shortName = "maxCycle", doc = "The maximum cycle value permitted for the Cycle covariate", optional = true)
     ...
     */
    @Option(fullName = "mismatches_default_quality", shortName = "mdq", doc = "default quality for the base mismatches covariate", optional = true)
     ...
     */
    @Option(fullName = "insertions_default_quality", shortName = "idq", doc = "default quality for the base insertions covariate", optional = true)
     ...
     */
    @Option(fullName = "deletions_default_quality", shortName = "ddq", doc = "default quality for the base deletions covariate", optional = true)
     ...
     */
    @Option(fullName = "low_quality_tail", shortName = "lqt", doc = "minimum quality for the bases in the tail of the reads to be considered", optional = true)
     ...
     */
    @Option(fullName = "quantizing_levels", shortName = "ql", optional = true, doc = "number of distinct quality scores in the quantized output")
    public int QUANTIZING_LEVELS = 16;

    /**
     * The tag name for the binary tag covariate (if using it)
     */
    @Option(fullName = "binary_tag_name", shortName = "bintag", optional = true, doc = "the binary tag covariate name if using it")
     ...
     */
    @Option(fullName = "sort_by_all_columns", shortName = "sortAllCols", doc = "Sort the rows in the tables of reports", optional = true)
    ...
    @HiddenOption
    @Option(fullName = "default_platform", shortName = "dP", optional = true, doc = "If a read has no platform then default to the provided String. Valid options are illumina, 454, and solid.")
    public String DEFAULT_PLATFORM = null;

    @HiddenOption
    @Option(fullName = "force_platform", shortName = "fP", optional = true, doc = "If provided, the platform of EVERY read will be forced to be the provided String. Valid options are illumina, 454, and solid.")
    public String FORCE_PLATFORM = null;

    @HiddenOption
    @Option(fullName = "force_readgroup", shortName = "fRG", optional = true, doc = "If provided, the read group of EVERY read will be forced to be the provided String.")
    public String FORCE_READGROUP = null;

    @HiddenOption
    @Option(fullName = "recal_table_update_log", shortName = "recal_table_update_log", optional = true, doc = "If provided, log all updates to the recalibration tables to the given file. For debugging/testing purposes only")
     ...
     */
    @HiddenOption
    @Option(fullName = "max_str_unit_length", shortName = "maxstr", doc = "Max size of the k-mer context to be used for repeat covariates", optional = true)
    public int MAX_STR_UNIT_LENGTH = 8;

    @HiddenOption
    @Option(fullName = "max_repeat_length", shortName = "maxrep", doc = "Max number of repetitions to be used for repeat covariates", optional = true)
