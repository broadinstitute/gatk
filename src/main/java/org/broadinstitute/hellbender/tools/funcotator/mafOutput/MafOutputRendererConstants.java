...
class MafOutputRendererConstants {
    ...
    // Field Names:
    static final String FieldName_Hugo_Symbol                            = "Hugo_Symbol";
    static final String FieldName_Entrez_Gene_Id                         = "Entrez_Gene_Id";
    static final String FieldName_Center                                 = "Center";
    static final String FieldName_NCBI_Build                             = "NCBI_Build";
    static final String FieldName_Chromosome                             = "Chromosome";
    static final String FieldName_Start_Position                         = "Start_Position";
    static final String FieldName_End_Position                           = "End_Position";
    static final String FieldName_Strand                                 = "Strand";
    static final String FieldName_Variant_Classification                 = "Variant_Classification";
    static final String FieldName_Variant_Type                           = "Variant_Type";
    static final String FieldName_Reference_Allele                       = "Reference_Allele";
    static final String FieldName_Tumor_Seq_Allele1                      = "Tumor_Seq_Allele1";
    static final String FieldName_Tumor_Seq_Allele2                      = "Tumor_Seq_Allele2";
    static final String FieldName_dbSNP_RS                               = "dbSNP_RS";
    static final String FieldName_dbSNP_Val_Status                       = "dbSNP_Val_Status";
    static final String FieldName_Tumor_Sample_Barcode                   = "Tumor_Sample_Barcode";
    static final String FieldName_Matched_Norm_Sample_Barcode            = "Matched_Norm_Sample_Barcode";
    static final String FieldName_Match_Norm_Seq_Allele1                 = "Match_Norm_Seq_Allele1";
    static final String FieldName_Match_Norm_Seq_Allele2                 = "Match_Norm_Seq_Allele2";
    static final String FieldName_Tumor_Validation_Allele1               = "Tumor_Validation_Allele1";
    static final String FieldName_Tumor_Validation_Allele2               = "Tumor_Validation_Allele2";
    static final String FieldName_Match_Norm_Validation_Allele1          = "Match_Norm_Validation_Allele1";
    static final String FieldName_Match_Norm_Validation_Allele2          = "Match_Norm_Validation_Allele2";
    static final String FieldName_Verification_Status                    = "Verification_Status";
    static final String FieldName_Validation_Status                      = "Validation_Status";
    static final String FieldName_Mutation_Status                        = "Mutation_Status";
    static final String FieldName_Sequencing_Phase                       = "Sequencing_Phase";
    static final String FieldName_Sequence_Source                        = "Sequence_Source";
    static final String FieldName_Validation_Method                      = "Validation_Method";
    static final String FieldName_Score                                  = "Score";
    static final String FieldName_BAM_File                               = "BAM_File";
    static final String FieldName_Sequencer                              = "Sequencer";
    static final String FieldName_Tumor_Sample_UUID                      = "Tumor_Sample_UUID";
    static final String FieldName_Matched_Norm_Sample_UUID               = "Matched_Norm_Sample_UUID";
    static final String FieldName_Genome_Change                          = "Genome_Change";
    static final String FieldName_Annotation_Transcript                  = "Annotation_Transcript";
    static final String FieldName_Transcript_Strand                      = "Transcript_Strand";
    static final String FieldName_Transcript_Exon                        = "Transcript_Exon";
    static final String FieldName_Transcript_Position                    = "Transcript_Position";
    static final String FieldName_cDNA_Change                            = "cDNA_Change";
    static final String FieldName_Codon_Change                           = "Codon_Change";
    static final String FieldName_Protein_Change                         = "Protein_Change";
    static final String FieldName_Other_Transcripts                      = "Other_Transcripts";
    static final String FieldName_Refseq_mRNA_Id                         = "Refseq_mRNA_Id";
    static final String FieldName_Refseq_prot_Id                         = "Refseq_prot_Id";
    static final String FieldName_SwissProt_acc_Id                       = "SwissProt_acc_Id";
    static final String FieldName_SwissProt_entry_Id                     = "SwissProt_entry_Id";
    static final String FieldName_Description                            = "Description";
    static final String FieldName_UniProt_AApos                          = "UniProt_AApos";
    static final String FieldName_UniProt_Region                         = "UniProt_Region";
    static final String FieldName_UniProt_Site                           = "UniProt_Site";
    static final String FieldName_UniProt_Natural_Variations             = "UniProt_Natural_Variations";
    static final String FieldName_UniProt_Experimental_Info              = "UniProt_Experimental_Info";
    static final String FieldName_GO_Biological_Process                  = "GO_Biological_Process";
    static final String FieldName_GO_Cellular_Component                  = "GO_Cellular_Component";
    static final String FieldName_GO_Molecular_Function                  = "GO_Molecular_Function";
    static final String FieldName_COSMIC_overlapping_mutations           = "COSMIC_overlapping_mutations";
    static final String FieldName_COSMIC_fusion_genes                    = "COSMIC_fusion_genes";
    static final String FieldName_COSMIC_tissue_types_affected           = "COSMIC_tissue_types_affected";
    static final String FieldName_COSMIC_total_alterations_in_gene       = "COSMIC_total_alterations_in_gene";
    static final String FieldName_Tumorscape_Amplification_Peaks         = "Tumorscape_Amplification_Peaks";
    static final String FieldName_Tumorscape_Deletion_Peaks              = "Tumorscape_Deletion_Peaks";
    static final String FieldName_TCGAscape_Amplification_Peaks          = "TCGAscape_Amplification_Peaks";
    static final String FieldName_TCGAscape_Deletion_Peaks               = "TCGAscape_Deletion_Peaks";
    static final String FieldName_DrugBank                               = "DrugBank";
    static final String FieldName_ref_context                            = "ref_context";
    static final String FieldName_gc_content                             = "gc_content";
    static final String FieldName_CCLE_ONCOMAP_overlapping_mutations     = "CCLE_ONCOMAP_overlapping_mutations";
    static final String FieldName_CCLE_ONCOMAP_total_mutations_in_gene   = "CCLE_ONCOMAP_total_mutations_in_gene";
    static final String FieldName_CGC_Mutation_Type                      = "CGC_Mutation_Type";
    static final String FieldName_CGC_Translocation_Partner              = "CGC_Translocation_Partner";
    static final String FieldName_CGC_Tumor_Types_Somatic                = "CGC_Tumor_Types_Somatic";
    static final String FieldName_CGC_Tumor_Types_Germline               = "CGC_Tumor_Types_Germline";
    static final String FieldName_CGC_Other_Diseases                     = "CGC_Other_Diseases";
    static final String FieldName_DNARepairGenes_Activity_linked_to_OMIM = "DNARepairGenes_Activity_linked_to_OMIM";
    static final String FieldName_FamilialCancerDatabase_Syndromes       = "FamilialCancerDatabase_Syndromes";
    static final String FieldName_MUTSIG_Published_Results               = "MUTSIG_Published_Results";
    static final String FieldName_OREGANNO_ID                            = "OREGANNO_ID";
    static final String FieldName_OREGANNO_Values                        = "OREGANNO_Values";
    ...
    static final List<String> OutputFieldNameMap_Hugo_Symbol                            = Arrays.asList(FieldName_Hugo_Symbol, "Gencode_19_hugoSymbol", "gene", "Gene");
    ...
    static final List<String> OutputFieldNameMap_NCBI_Build                             = Arrays.asList(FieldName_NCBI_Build, "Gencode_19_ncbiBuild", "ncbi_build");
    static final List<String> OutputFieldNameMap_Chromosome                             = Arrays.asList(FieldName_Chromosome, "Gencode_19_chromosome", "chr", "contig", "chromosome", "chrom", "Chrom");
    static final List<String> OutputFieldNameMap_Start_Position                         = Arrays.asList(FieldName_Start_Position, "Start_position", "Gencode_19_start", "start", "Start", "start_pos", "pos");
    static final List<String> OutputFieldNameMap_End_Position                           = Arrays.asList(FieldName_End_Position, "End_position", "Gencode_19_end", "end", "End", "end_pos");
    static final List<String> OutputFieldNameMap_Strand                                 = Collections.singletonList(FieldName_Strand);
    static final List<String> OutputFieldNameMap_Variant_Classification                 = Arrays.asList(FieldName_Variant_Classification, "Gencode_19_variantClassification", "variant_classification");
    static final List<String> OutputFieldNameMap_Variant_Type                           = Arrays.asList(FieldName_Variant_Type, "Gencode_19_variantType", "variant_type");
    static final List<String> OutputFieldNameMap_Reference_Allele                       = Arrays.asList(FieldName_Reference_Allele, "Gencode_19_refAllele", "ref", "ref_allele", "reference_allele");
    static final List<String> OutputFieldNameMap_Tumor_Seq_Allele1                      = Arrays.asList(FieldName_Tumor_Seq_Allele1, "Gencode_19_tumorSeqAllele1", "ref", "ref_allele", "reference_allele");
    static final List<String> OutputFieldNameMap_Tumor_Seq_Allele2                      = Arrays.asList(FieldName_Tumor_Seq_Allele2, "Gencode_19_tumorSeqAllele2", "alt", "alt_allele", "alt2", "alt_allele2", "alternate_allele2", "observed_allele2", "alternate_allele", "observed_allele", "alt1", "alt_allele1", "alternate_allele1", "observed_allele1");
    static final List<String> OutputFieldNameMap_dbSNP_RS                               = Arrays.asList(FieldName_dbSNP_RS, "dbsnp_rs");
    static final List<String> OutputFieldNameMap_dbSNP_Val_Status                       = Arrays.asList(FieldName_dbSNP_Val_Status, "dbsnp_val_status");
    ...
    static final List<String> OutputFieldNameMap_Genome_Change                          = Arrays.asList(FieldName_Genome_Change, "Gencode_19_genomeChange", "genome_change");
    static final List<String> OutputFieldNameMap_Annotation_Transcript                  = Arrays.asList(FieldName_Annotation_Transcript, "Gencode_19_annotationTranscript", "annotation_transcript", "transcript_id");
    static final List<String> OutputFieldNameMap_Transcript_Strand                      = Arrays.asList(FieldName_Transcript_Strand, "Gencode_19_transcriptStrand", "transcript_strand");
    static final List<String> OutputFieldNameMap_Transcript_Exon                        = Arrays.asList(FieldName_Transcript_Exon, "Gencode_19_transcriptExon", "transcript_exon");
    static final List<String> OutputFieldNameMap_Transcript_Position                    = Arrays.asList(FieldName_Transcript_Position, "Gencode_19_transcriptPos", "transcript_position");
    static final List<String> OutputFieldNameMap_cDNA_Change                            = Arrays.asList(FieldName_cDNA_Change, "Gencode_19_cDnaChange", "transcript_change");
    static final List<String> OutputFieldNameMap_Codon_Change                           = Arrays.asList(FieldName_Codon_Change, "Gencode_19_codonChange", "codon_change");
    static final List<String> OutputFieldNameMap_Protein_Change                         = Arrays.asList(FieldName_Protein_Change, "Gencode_19_proteinChange", "protein_change");
    static final List<String> OutputFieldNameMap_Other_Transcripts                      = Arrays.asList(FieldName_Other_Transcripts, "Gencode_19_otherTranscripts", "other_transcripts");
    ...
    static final List<String> OutputFieldNameMap_ref_context                            = Arrays.asList(FieldName_ref_context, "Gencode_19_referenceContext", "ref_context");
    static final List<String> OutputFieldNameMap_gc_content                             = Arrays.asList(FieldName_gc_content, "Gencode_19_gcContent", "gc_content");
