...
public class MafOutputRendererConstants {
    ...
    public static final String FieldName_gene_transcript_type                   = "gene_transcript_type";
    ...
    static final List<String> OutputFieldNameMap_Hugo_Symbol                            = Arrays.asList(FieldName_Hugo_Symbol, "Gencode_19_hugoSymbol", "Gencode_27_hugoSymbol", "Gencode_28_hugoSymbol", "Gencode_34_hugoSymbol", "gene", "Gene");
    ...
    static final List<String> OutputFieldNameMap_NCBI_Build                             = Arrays.asList(FieldName_NCBI_Build, "Gencode_19_ncbiBuild", "Gencode_27_ncbiBuild", "Gencode_28_ncbiBuild", "Gencode_34_ncbiBuild", "ncbi_build");
    static final List<String> OutputFieldNameMap_Chromosome                             = Arrays.asList(FieldName_Chromosome, "Gencode_19_chromosome", "Gencode_27_chromosome", "Gencode_28_chromosome", "Gencode_34_chromosome", "chr", "contig", "chromosome", "chrom", "Chrom");
    static final List<String> OutputFieldNameMap_Start_Position                         = Arrays.asList(FieldName_Start_Position, "Start_position", "Gencode_19_start", "Gencode_27_start", "Gencode_28_start", "Gencode_34_start", "start", "Start", "start_pos", "pos");
    static final List<String> OutputFieldNameMap_End_Position                           = Arrays.asList(FieldName_End_Position, "End_position", "Gencode_19_end", "Gencode_27_end", "Gencode_28_end", "Gencode_34_end", "end", "End", "end_pos");
    static final List<String> OutputFieldNameMap_Strand                                 = Collections.singletonList(FieldName_Strand);
    static final List<String> OutputFieldNameMap_Variant_Classification                 = Arrays.asList(FieldName_Variant_Classification, "Gencode_19_variantClassification", "Gencode_27_variantClassification", "Gencode_28_variantClassification", "Gencode_34_variantClassification", "variant_classification");
    static final List<String> OutputFieldNameMap_Variant_Type                           = Arrays.asList(FieldName_Variant_Type, "Gencode_19_variantType", "Gencode_27_variantType", "Gencode_28_variantType", "Gencode_34_variantType", "variant_type");
    static final List<String> OutputFieldNameMap_Reference_Allele                       = Arrays.asList(FieldName_Reference_Allele, "Gencode_19_refAllele", "Gencode_27_refAllele", "Gencode_28_refAllele", "Gencode_34_refAllele", "ref", "ref_allele", "reference_allele");
    static final List<String> OutputFieldNameMap_Tumor_Seq_Allele1                      = Arrays.asList(FieldName_Tumor_Seq_Allele1, "Gencode_19_tumorSeqAllele1", "Gencode_27_tumorSeqAllele1", "Gencode_28_tumorSeqAllele1", "Gencode_34_tumorSeqAllele1", "ref", "ref_allele", "reference_allele");
    ...
    static final List<String> OutputFieldNameMap_Genome_Change                          = Arrays.asList(FieldName_Genome_Change, "Gencode_19_genomeChange", "Gencode_27_genomeChange", "Gencode_28_genomeChange", "Gencode_34_genomeChange", "genome_change");
    static final List<String> OutputFieldNameMap_Annotation_Transcript                  = Arrays.asList(FieldName_Annotation_Transcript, "Gencode_19_annotationTranscript", "Gencode_27_annotationTranscript", "Gencode_28_annotationTranscript", "Gencode_34_annotationTranscript", "annotation_transcript", "transcript_id");
    static final List<String> OutputFieldNameMap_Transcript_Strand                      = Arrays.asList(FieldName_Transcript_Strand, "Gencode_19_transcriptStrand", "Gencode_27_transcriptStrand", "Gencode_28_transcriptStrand", "Gencode_34_transcriptStrand", "transcript_strand");
    static final List<String> OutputFieldNameMap_Transcript_Exon                        = Arrays.asList(FieldName_Transcript_Exon, "Gencode_19_transcriptExon", "Gencode_27_transcriptExon", "Gencode_28_transcriptExon", "Gencode_34_transcriptExon", "transcript_exon");
    static final List<String> OutputFieldNameMap_Transcript_Position                    = Arrays.asList(FieldName_Transcript_Position, "Gencode_19_transcriptPos", "Gencode_27_transcriptPos", "Gencode_28_transcriptPos", "Gencode_34_transcriptPos", "transcript_position");
    static final List<String> OutputFieldNameMap_cDNA_Change                            = Arrays.asList(FieldName_cDNA_Change, "Gencode_19_cDnaChange", "Gencode_27_cDnaChange", "Gencode_28_cDnaChange", "Gencode_34_cDnaChange", "transcript_change");
    static final List<String> OutputFieldNameMap_Codon_Change                           = Arrays.asList(FieldName_Codon_Change, "Gencode_19_codonChange", "Gencode_27_codonChange", "Gencode_28_codonChange", "Gencode_34_codonChange", "codon_change");
    static final List<String> OutputFieldNameMap_Protein_Change                         = Arrays.asList(FieldName_Protein_Change, "Gencode_19_proteinChange", "Gencode_27_proteinChange", "Gencode_28_proteinChange", "Gencode_34_proteinChange", "protein_change");
    static final List<String> OutputFieldNameMap_Other_Transcripts                      = Arrays.asList(FieldName_Other_Transcripts, "Gencode_19_otherTranscripts", "Gencode_27_otherTranscripts", "Gencode_28_otherTranscripts", "Gencode_34_otherTranscripts", "other_transcripts");
    ...
    static final List<String> OutputFieldNameMap_ref_context                            = Arrays.asList(FieldName_ref_context, "Gencode_19_referenceContext", "Gencode_27_referenceContext", "Gencode_28_referenceContext", "Gencode_34_referenceContext", "ref_context");
    static final List<String> OutputFieldNameMap_gene_transcript_type                   = Arrays.asList(FieldName_gene_transcript_type, "Gencode_19_geneTranscriptType", "Gencode_27_geneTranscriptType", "Gencode_28_geneTranscriptType", "Gencode_34_geneTranscriptType", "gene_transcript_type");
    static final List<String> OutputFieldNameMap_gc_content                             = Arrays.asList(FieldName_gc_content, "Gencode_19_gcContent", "Gencode_27_gcContent", "Gencode_28_gcContent", "Gencode_34_gcContent", "gc_content");
