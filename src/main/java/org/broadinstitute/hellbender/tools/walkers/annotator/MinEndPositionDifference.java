...
public class MinEndPositionDifference extends PerAlleleAnnotation implements StandardMutectAnnotation {
    ...
    protected int aggregate(final List<Integer> values) {
        ...
        System.out.println("min end difference = " + positiveMax);
    ...
    protected String getVcfKey() {
        return GATKVCFConstants.READ_END_POSITION_MIN_DIFF_KEY;
    }
