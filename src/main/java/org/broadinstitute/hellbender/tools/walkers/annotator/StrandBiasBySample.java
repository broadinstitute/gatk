 ...
 *     <li>StrandBiasBySample is an intermediate annotation used for calculating FisherStrand (FS) and StrandOddsRatio (SOR), so it will not show up in VCFs after using the GenotypeGVCFs tool.</li>
 * </ul>
 *
