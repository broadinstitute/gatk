...
public class RampedHaplotypeCallerEngine extends HaplotypeCallerEngine {
    ...
    private void assemble(final CallRegionContext context) {
        ...
        try {
            ...
            Tuple<List<VariantContext>, List<VariantContext>> forcedPileupAlleles = new Tuple<>(Collections.emptyList(), Collections.emptyList()); // TODO: we currently do not support pileup alleles in RampedHaplotypeCaller, this should be added
