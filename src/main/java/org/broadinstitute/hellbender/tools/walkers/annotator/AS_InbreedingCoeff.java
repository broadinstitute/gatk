...
public final class AS_InbreedingCoeff extends InfoFieldAnnotation implements AS_StandardAnnotation {
    ...
    public Map<String, Object> annotate(final ReferenceContext ref,
        ...
        Utils.nonNull(vc);
        final HeterozygosityUtils heterozygosityUtils = new HeterozygosityUtils(vc);
    ...
    @VisibleForTesting
    double calculateIC(final VariantContext vc, final Allele altAllele) {
        //make a new HeterozygosityUtils for each call to reset it
        return calculateIC(vc, altAllele, new HeterozygosityUtils(vc));
    }

    private double calculateIC(final VariantContext vc, final Allele altAllele, final HeterozygosityUtils heterozygosityUtils) {
