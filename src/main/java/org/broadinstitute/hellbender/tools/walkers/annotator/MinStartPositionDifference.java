...
public class MinStartPositionDifference extends PerAlleleAnnotation implements StandardMutectAnnotation {
    ...
    protected int aggregate(final List<Integer> values) {
        ...
        System.out.println("min start difference = " + positiveMax);
    ...
    protected String getVcfKey() {
        return GATKVCFConstants.READ_START_POSITION_MIN_DIFF_KEY;
    }
