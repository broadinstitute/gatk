...
//            optional = true
//    )
//    private int maximumChunkSize = VariantLabeledAnnotationsWalker.DEFAULT_MAXIMUM_CHUNK_SIZE;
//
//    @Override
...
//            final double[][] allData = VariantLabeledAnnotationsData.readAnnotationsBatch(inputAnnotationsFile);
//            final String[] annotationNames = VariantLabeledAnnotationsData.readAnnotationNames(inputAnnotationsFile);
//            final List<Boolean> isTraining = VariantLabeledAnnotationsData.readLabel(inputAnnotationsFile, VariantLabeledAnnotationsData.TRAINING_LABEL);
//            final List<Boolean> isTruth = VariantLabeledAnnotationsData.readLabel(inputAnnotationsFile, VariantLabeledAnnotationsData.TRUTH_LABEL); // TODO make truth optional
