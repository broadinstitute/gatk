 ...
 */
public final class VariationalAlleleFrequencyCalculator implements AlleleFrequencyCalculator {
    ...
    public static VariationalAlleleFrequencyCalculator makeCalculator(GenotypeCalculationArgumentCollection genotypeArgs) {
        ...
        return new VariationalAlleleFrequencyCalculator(refPseudocount, snpPseudocount, indelPseudocount, genotypeArgs.samplePloidy);
    }

    public static VariationalAlleleFrequencyCalculator makeCalculator(DragstrParams dragstrParms, int period, int repeats, int ploidy, double snpHeterozygosity, double scale) {
        ...
        return  new VariationalAlleleFrequencyCalculator(refPseudoCount, snpPseudoCount, indelPseudoCount, ploidy);
    }
    ...
    public VariationalAlleleFrequencyCalculator(final double refPseudocount, final double snpPseudocount, final double indelPseudocount, final int defaultPloidy) {
