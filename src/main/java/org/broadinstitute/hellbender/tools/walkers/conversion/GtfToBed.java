...
//            System.out.println("Tag == basic");
            ...
            for(GencodeGtfFeature gtfFeature: geneFeature) {
                if (gtfFeature.getFeatureType() == GencodeGtfFeature.FeatureType.GENE) {
                    System.out.println("Type is gene: " + gtfFeature.getFeatureType() + " gene id = " + gtfFeature.getGeneId());
                ...
                if (gtfFeature.getFeatureType() == GencodeGtfFeature.FeatureType.TRANSCRIPT) {
                    System.out.println("type is transcript: " + gtfFeature.getFeatureType() + " transcript id = " + gtfFeature.getTranscriptId());
...
//        try (BufferedWriter writer = new BufferedWriter(new FileWriter(/*bedFilePath*/))) { //TODO: figure out what should be the input
