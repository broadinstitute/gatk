        ...
        public static Tuple2<String, List<AlignmentInterval>> parseTextFileAlignmentIntervalLines(final String textLine) {
            ...
            try {
                ...
                for (int i = 1; i < fields.length; ++i) {
                    ...
                    intervals.add(new AlignmentInterval(AlignAssembledContigsSpark.decodeStringAsSimpleInterval(intervalFields[1]), contigStart, contigEnd,
                            TextCigarCodec.decode(intervalFields[2]), intervalFields[3].equals("+"),
