...
public class LargeDeletionFactory extends LargeSimpleSVFactory {
    ...
    protected LargeSimpleSV getNewSV(final int start,
        ...
        return new LargeSimpleSV(SimpleSVType.TYPES.DEL, LargeSimpleSV.EvidenceType.READ_PAIR, start, end, contigId, readPairEvidence, splitReadEvidence, readPairCounterEvidence, splitReadCounterEvidence, breakpoints, supportingEvidence);
    }
    ...
    protected boolean hasSupportingEvidenceOrientation(final EvidenceTargetLink link) {
        return hasInnieOrientation(link);
    }
