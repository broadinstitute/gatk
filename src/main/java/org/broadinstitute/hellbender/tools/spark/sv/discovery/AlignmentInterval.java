...
public final class AlignmentInterval {
    ...
    public AlignmentInterval(final BwaMemAlignment alignment, final List<String> refNames, final int unclippedContigLength) {
        ...
        Utils.validateArg(
                cigarAlong5to3DirectionOfContig.getReadLength() + SVVariantDiscoveryUtils.getTotalHardClipping(cigarAlong5to3DirectionOfContig)
    ...
    static int getAlignmentEndInOriginalContig(final SAMRecord samRecord) {
        ...
        return cigar.getReadLength() + SVVariantDiscoveryUtils.getTotalHardClipping(cigar) -
                SVVariantDiscoveryUtils.getNumClippedBases(samRecord.getReadNegativeStrandFlag(), cigar);
    }
