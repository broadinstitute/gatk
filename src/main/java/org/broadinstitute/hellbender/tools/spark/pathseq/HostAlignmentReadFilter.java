...
public final class HostAlignmentReadFilter extends ReadFilter {
    ...
    public boolean test(final Cigar c, final int NM) {
        ...
        return numCov < MIN_COVERAGE || numMatches < MIN_IDENTITY;
    }
