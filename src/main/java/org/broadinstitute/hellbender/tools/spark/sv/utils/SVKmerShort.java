...
public class SVKmerShort extends SVKmer implements Comparable<SVKmerShort> {
    ...
    private SVKmerShort( final Input input ) {
    ...
    /**
     * Kmer is canonical if middle base is A or C.
     */
    @Override
     ...
     */
    @Override
    public SVKmerShort canonical( final int kSize ) { return isCanonical(kSize) ? this : reverseComplement(kSize); }

    @Override
    public final Base firstBase( final int kSize ) { return baseValues.get((int)(valLow >> (kSize*2-2))); }
    @Override
    ...
    public final int hashCode() {
        ...
        final long val = SVUtils.fnvLong64(valLow);
    ...
    /**
     * Not an override of the Object method.  An SVKmerShort doesn't know what K is, so it has to be supplied.
     */
    @Override
