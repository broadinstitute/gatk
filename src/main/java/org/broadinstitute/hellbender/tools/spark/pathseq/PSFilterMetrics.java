...
public final class PSFilterMetrics extends MetricBase implements Serializable {
    ...
    public void computeDerivedMetrics() {
        Utils.nonNull(PRIMARY_READS, "Cannot compute metrics if PRIMARY_READS is null");
        Utils.nonNull(READS_AFTER_PREALIGNED_HOST_FILTER, "Cannot compute metrics if READS_AFTER_PREALIGNED_HOST_FILTER is null");
        Utils.nonNull(READS_AFTER_QUALITY_AND_COMPLEXITY_FILTER, "Cannot compute metrics if READS_AFTER_QUALITY_AND_COMPLEXITY_FILTER is null");
        Utils.nonNull(READS_AFTER_HOST_FILTER, "Cannot compute metrics if READS_AFTER_HOST_FILTER is null");
        Utils.nonNull(READS_AFTER_DEDUPLICATION, "Cannot compute metrics if READS_AFTER_DEDUPLICATION is null");
        Utils.nonNull(FINAL_PAIRED_READS, "Cannot compute metrics if FINAL_PAIRED_READS is null");
