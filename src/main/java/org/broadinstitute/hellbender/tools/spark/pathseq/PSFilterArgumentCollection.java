...
public final class PSFilterArgumentCollection implements Serializable {
    ...
    public void validateFilterArguments(final SAMFileHeader readsHeader) {
        final SAMSequenceDictionary dictionary = readsHeader.getSequenceDictionary();
        if (this.alignedInput) {
            final Set<String> contigsToIgnoreSet = new HashSet<>(this.alignmentContigsToIgnore);
