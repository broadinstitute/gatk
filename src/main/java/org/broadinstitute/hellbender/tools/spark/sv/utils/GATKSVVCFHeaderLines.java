...
public final class GATKSVVCFHeaderLines {
    ...
    static {
        ...
        addInfoLine(new VCFInfoHeaderLine(GATKSVVCFConstants.DUP_ORIENTATIONS, VCFHeaderLineCount.A, VCFHeaderLineType.String,
                "Orientations of the duplicated sequence on alt allele relative to the copy on ref; one group for each alt allele (currently only available for inverted duplication variants)"));
