...
public final class GATKSVVCFConstants {
    ...
    public static final String TRUTH_INTERVAL_RECIPROCAL_OVERLAP_INFO = "TRUTH_INTERVAL_RECIPROCAL_OVERLAP";
    public static final String TRUTH_INTERVAL_SIZE_SIMILARITY_INFO = "TRUTH_INTERVAL_SIZE_SIMILARITY";
    public static final String TRUTH_INTERVAL_START_DISTANCE_INFO = "TRUTH_INTERVAL_START_DISTANCE";
    public static final String TRUTH_INTERVAL_END_DISTANCE_INFO = "TRUTH_INTERVAL_END_DISTANCE";
