...
public final class AlleleFractionSegmentedPlotter {
     ...
     */
    public static void writeSegmentedAlleleFractionPlot(final String sampleName, final String snpCountsFile,
        ...
        executor.addArgs("--args", "--sample_name="+sampleName, "--snp_counts_file="+snpCountsFile,  "--segments_file="+segmentsFile,
