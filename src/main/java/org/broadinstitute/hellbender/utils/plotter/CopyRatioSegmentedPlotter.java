...
public final class CopyRatioSegmentedPlotter {
     ...
     */
    public static void writeSegmentedCopyRatioPlot(final String sample_name, final String tnFile, final String preTnFile,
        ...
        executor.addArgs("--args", "--sample_name="+sample_name, "--targets_file="+tnFile, "--pre_tn_file="+preTnFile, "--segments_file="+segmentsFile,
