...
public final class AlignmentUtils {
    ...
    public static GATKRead createReadAlignedToRef(final GATKRead originalRead,
        ...
        final SmithWatermanAlignment readToHaplotypeSWAlignment = aligner.align(haplotype.getBases(), originalRead.getBases(), readToHaplotypeSWParameters, SWOverhangStrategy.SOFTCLIP);
