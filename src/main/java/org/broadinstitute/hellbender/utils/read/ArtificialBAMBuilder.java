...
public final class ArtificialBAMBuilder {
    ...
    public ArtificialBAMBuilder createAndSetHeader(final int nSamples) {
        ...
        header.setSequenceDictionary(parser.getSequenceDictionary());
        samples.clear();
     ...
     * @return the BAM file
     */
    public File makeTemporarilyBAMFile() throws IOException{
    ...
    public File makeBAMFile(final File output) {
        ...
        try(final SAMFileWriter writer = factory.makeBAMWriter(header, true, output, 0)) {
