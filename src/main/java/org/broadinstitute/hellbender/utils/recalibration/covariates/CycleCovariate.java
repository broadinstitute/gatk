...
public final class CycleCovariate implements Covariate {
    ...
    public static int keyFromCycle(final int cycle, final int maxCycle) {
        ...
        if ( result > maxCycle ) {
            throw new UserException("The maximum allowed value for the cycle is " + maxCycle + ", but a larger cycle (" + result + ") was detected.  Please use the --maximum-cycle-value argument to increase this value (at the expense of requiring more memory to run)");
        }
