...
public class GATKVCFHeaderLines {
    ...
    static {
        ...
        addInfoLine(new VCFInfoHeaderLine(AS_VQS_CAL_SENS_KEY, VCFHeaderLineCount.A, VCFHeaderLineType.String, "For each alt allele, the calibration sensitivity threshold of being a true variant versus being false under the trained gaussian mixture model"));
