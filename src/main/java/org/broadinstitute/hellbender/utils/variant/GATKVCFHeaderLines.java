...
public class GATKVCFHeaderLines {
    ...
    static {
        ...
        addFormatLine(new VCFFormatHeaderLine(HAPLOTYPE_CALLER_PHASING_GT_KEY, 1, VCFHeaderLineType.String, "Physical phasing haplotype information, describing how the alternate alleles are phased in relation to one another; assigned as heterozygous in GVCFs; allele indexes are local to the called genotype"));
