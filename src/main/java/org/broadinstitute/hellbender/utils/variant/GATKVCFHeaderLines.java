...
public class GATKVCFHeaderLines {
    ...
    static {
        addFilterLine(new VCFFilterHeaderLine(MONOMORPHIC_FILTER_NAME,  "monomorphic"));
        addInfoLine(new VCFInfoHeaderLine(SB_TABLE_KEY, 4, VCFHeaderLineType.Integer, "table"));
        ...
        addInfoLine(new VCFInfoHeaderLine(AS_QUAL_APPROX, 1, VCFHeaderLineType.String, "Allele-specific Variant Qual approximation"));
