...
public class ZipUtils {
    ...
    public static final void unzip(final String path, final File dest, final String ... files) {
        ...
        try (final ZipInputStream in = new ZipInputStream(BucketUtils.openFile(path))) {
            ZipEntry entry;
            ...
            throw new GATKException(path, ex);
        }
    }
     ...
     */
    public static void zip(final File source, final String dest, final String ... files) {
     ...
     */
    private static void uncheckedZip(final File sourceRoot, final String dest, final Predicate<File> selection) {
        try (final ZipOutputStream out = new ZipOutputStream(BucketUtils.createFile(dest))) {
