...
public final class TableCodecUnitTest extends BaseTest {
    ...
    public void testChrs(){
        TableCodec tc = new TableCodec();
        Assert.assertNotNull(tc.decode("1:1  1   2   3").getChr(), "1");
        Assert.assertNotNull(tc.decode("chr1:1  1   2   3").getChr(), "chr1");
        Assert.assertNotNull(tc.decode("1:1  1   2   3").toString(), "1");
    }
    ...
    public Object[][] stringNull() {
        List<Object[]> params = new ArrayList<>();
        params.add(new String[]{TableCodec.headerDelimiter + " foo"});
        params.add(new String[]{TableCodec.headerDelimiter + " bar"});
        params.add(new String[]{TableCodec.igvHeaderDelimiter + " baz"});
        return params.toArray(new Object[][]{});
    }
    ...
    public Object[][] stringNotNull() {
        List<Object[]> params = new ArrayList<>();
        params.add(new String[]{"foo " + TableCodec.headerDelimiter});
        params.add(new String[]{"foo " + TableCodec.headerDelimiter});
        params.add(new String[]{"foo " + TableCodec.igvHeaderDelimiter});
        return params.toArray(new Object[][]{});
    }
