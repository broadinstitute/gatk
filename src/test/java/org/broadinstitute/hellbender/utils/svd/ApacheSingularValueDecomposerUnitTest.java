...
import org.broadinstitute.hellbender.utils.exome.ReadCountCollection;
import org.broadinstitute.hellbender.utils.exome.ReadCountCollectionUtils;
...
public class ApacheSingularValueDecomposerUnitTest extends BaseTest {
    private static final File TEST_FILE_DIR = new File("src/test/resources/org/broadinstitute/hellbender/utils/exome");
