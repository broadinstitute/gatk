...
public final class ReservoirDownsamplerUnitTest extends BaseTest {
    ...
    public void testReservoirDownsampler(final ReservoirDownsamplerTest test ) {
        ...
        final ReadsDownsampler<GATKRead> downsampler = new ReservoirDownsampler<>(test.reservoirSize);
    ...
    public void testSubmit() throws Exception {
        ReservoirDownsampler<GATKRead> rd = new ReservoirDownsampler<>(1, true);
