...
public final class DownsamplingMethodUnitTest {
    ...
    public void testToLibsInfoNone() throws Exception {
        final DownsamplingMethod none = DownsamplingMethod.NONE;
        final LIBSDownsamplingInfo libsDownsamplingInfo = DownsamplingMethod.toDownsamplingInfo(none);
    ...
    public void testToLibsInfoBySampleToCoverage() throws Exception {
        ...
        final LIBSDownsamplingInfo libsDownsamplingInfo = DownsamplingMethod.toDownsamplingInfo(bySample);
