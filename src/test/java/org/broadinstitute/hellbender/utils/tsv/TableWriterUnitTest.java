...
public final class TableWriterUnitTest extends BaseTest {
    ...
    public void testNoRecordsOutput() throws IOException {
        ...
        final TableColumns columnNames = new TableColumns("col1", "col2", "col3");
        final TableWriter<Object> writer = new TableWriter<Object>(testFile, columnNames) {
            @Override
            protected DataLine dataLine(Object record) {
                return dataLine().append(record.toString());
            }
        };
        writer.close();
        ...
        Assert.assertEquals(outLines.get(0), String.join("" + TableConstants.COLUMN_SEPARATOR, "col1", "col2", "col3"));
    }
    ...
    public void testNoRecordsOutputWithCommentsAndDuplicatedAttemptsToWriterHeader() throws IOException {
        ...
        Assert.assertEquals(outLines.get(0), TableConstants.COMMENT_PREFIX + "commentLine1");
        Assert.assertEquals(outLines.get(1), TableConstants.COMMENT_PREFIX + "commentLine2");
        Assert.assertEquals(outLines.get(2), String.join("" + TableConstants.COLUMN_SEPARATOR, "col1", "col2", "col3"));
        Assert.assertEquals(outLines.get(3), TableConstants.COMMENT_PREFIX + "commentLine3");
        Assert.assertEquals(outLines.get(4), TableConstants.COMMENT_PREFIX + "commentLine4");
    }
    ...
    public void testNoRecordsOutputWithComments() throws IOException {
        ...
        final TableWriter<Object> writer = new TableWriter<Object>(testFile, columnNames) {
            @Override
            protected DataLine dataLine(Object record) {
                return dataLine(record.toString());
            }
        };
        writer.writeComment("commentLine1");
        writer.writeComment("commentLine2");
    ...
    public void testSomeRecordsOutputWithCommentsAndLateAttemptToWriteHeader() throws IOException {
        ...
        final TableWriter<String[]> writer = new TableWriter<String[]>(testFile, columnNames) {
            @Override
            protected DataLine dataLine(String[] record) {
                return dataLine().append(record);
            }
        };
        writer.writeComment("commentLine1");
        writer.writeComment("commentLine2");
        ...
        Assert.assertEquals(outLines.get(1), TableConstants.COMMENT_PREFIX + "commentLine2");
        Assert.assertEquals(outLines.get(2), String.join("" + TableConstants.COLUMN_SEPARATOR, "col1", "col2", "col3"));
        Assert.assertEquals(outLines.get(3), String.join("" + TableConstants.COLUMN_SEPARATOR, "1", "2", "3"));
        Assert.assertEquals(outLines.get(4), String.join("" + TableConstants.COLUMN_SEPARATOR, "4", "5", "6"));
        Assert.assertEquals(outLines.get(5), TableConstants.COMMENT_PREFIX + "commentLine3");
        Assert.assertEquals(outLines.get(6), String.join("" + TableConstants.COLUMN_SEPARATOR, "-1", "-2", "-3"));
        Assert.assertEquals(outLines.get(7), TableConstants.COMMENT_PREFIX + "commentLine4");
    }
    ...
    public void testWriteRecordFromIterable() throws IOException {
        ...
        Assert.assertEquals(outLines.get(0), String.join("" + TableConstants.COLUMN_SEPARATOR, "col1", "col2", "col3"));
        Assert.assertEquals(outLines.get(1), String.join("" + TableConstants.COLUMN_SEPARATOR, "1", "2", "3"));
        Assert.assertEquals(outLines.get(2), String.join("" + TableConstants.COLUMN_SEPARATOR, "4", "5", "6"));
        Assert.assertEquals(outLines.get(3), String.join("" + TableConstants.COLUMN_SEPARATOR, "-1", "-2", "-3"));
    }
    ...
    public void testWriteRecordFromArray() throws IOException {
        ...
        final TableWriter<String[]> writer = new TableWriter<String[]>(testFile, columnNames) {
            @Override
            protected DataLine dataLine(final String[] record) {
                return dataLine().append(record);
            }
        };
        final List<String[]> records = new ArrayList<>(3);
    ...
    public void testTestTupleWriting() throws IOException {
        ...
        final TableWriter<TableReaderUnitTest.TestTuple>
                writer = new TableWriter<TableReaderUnitTest.TestTuple>(testFile, new TableColumns("col1.str", "col2.int", "col3.dbl")) {
            @Override
            protected DataLine dataLine(TableReaderUnitTest.TestTuple record) {
                return dataLine()
                        .set("col1.str", record.strValue)
