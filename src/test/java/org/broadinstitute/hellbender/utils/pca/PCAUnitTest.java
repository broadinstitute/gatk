 ...
 */
public final class PCAUnitTest {
     ...
     * The test matrix.
     */
    private final double[][] TEST_MATRIX = new double[][]{
     ...
     * </code>
     */
    private final double[][] TEST_EXPECTED_EIGENVECTORS = new double[][]{
     ...
     * </code>
     */
    private final double[] TEST_EXPECTED_CENTERS = new double[] {
     ...
     * </code>
     */
    private final double[] TEST_EXPECTED_SDEVS = new double[] {
     ...
     */
    private final double[] TEST_EXPECTED_VARS = DoubleStream.of(TEST_EXPECTED_SDEVS)
            .map(d -> d * d).toArray();
    ...
    public void testSparkSVDOnTestMatrix() {
        ...
        final PCA pca = PCA.createPCA(dataMatrix, dm -> SVDFactory.createSVD(dm, sparkContext));
        final RealVector centers = pca.getCenters();
        final RealVector variances = pca.getVariances();
        final RealMatrix eigenVectors = pca.getEigenVectors();
        Assert.assertNotNull(eigenVectors);
    ...
    private void assertEquals(final RealVector v1, final RealVector v2, final double epsilon) {
    ...
    private void assertEqualEigenVectors(final RealMatrix m1, final RealMatrix m2, final RealVector variances, final double epsilon) {
