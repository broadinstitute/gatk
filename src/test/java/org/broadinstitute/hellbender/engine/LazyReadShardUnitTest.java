...
public class LazyReadShardUnitTest extends BaseTest {
    ...
    public void testInvalidConstruction( final SimpleInterval shardInterval, final SimpleInterval shardPadding, final ReadsDataSource readsSource ) {
        final Shard<GATKRead> shard = new LazyReadShard(shardInterval, shardPadding, readsSource);
    }
    ...
    public Object[][] shardBoundsTestData() {
        ...
        return new Object[][] {
                { new LazyReadShard(new SimpleInterval("1", 200, 250), readsSource), new SimpleInterval("1", 200, 250), new SimpleInterval("1", 200, 250), "1", 200, 250, 0, 0 },
                { new LazyReadShard(new SimpleInterval("1", 200, 250), new SimpleInterval("1", 200, 250), readsSource), new SimpleInterval("1", 200, 250), new SimpleInterval("1", 200, 250), "1", 200, 250, 0, 0 },
                { new LazyReadShard(new SimpleInterval("1", 200, 250), new SimpleInterval("1", 190, 270), readsSource), new SimpleInterval("1", 200, 250), new SimpleInterval("1", 190, 270), "1", 200, 250, 10, 20 },
                { new LazyReadShard(new SimpleInterval("1", 200, 250), new SimpleInterval("1", 200, 270), readsSource), new SimpleInterval("1", 200, 250), new SimpleInterval("1", 200, 270), "1", 200, 250, 0, 20 },
                { new LazyReadShard(new SimpleInterval("1", 200, 250), new SimpleInterval("1", 190, 250), readsSource), new SimpleInterval("1", 200, 250), new SimpleInterval("1", 190, 250), "1", 200, 250, 10, 0 }
        };
    }

    @Test(dataProvider = "ShardBoundsTestData")
    public void testShardBounds(final LazyReadShard shard, final SimpleInterval expectedShardInterval, final SimpleInterval expectedPaddedInterval, final String expectedContig, final int expectedStart, final int expectedEnd, final int expectedNumLeftPaddingBases, final int expectedNumRightPaddingBases ) {
    ...
    public Object[][] shardContainsTestData() {
        ...
        return new Object[][] {
                ...
                { new LazyReadShard(new SimpleInterval("1", 200, 250), readsSource), new SimpleInterval("1", 200, 250), true, true },
                { new LazyReadShard(new SimpleInterval("1", 200, 250), readsSource), new SimpleInterval("1", 190, 250), false, false },
                { new LazyReadShard(new SimpleInterval("1", 200, 250), readsSource), new SimpleInterval("1", 200, 260), false, true },

                // Shard padding should not affect the results at all, and give the same results as above
                { new LazyReadShard(new SimpleInterval("1", 200, 250), new SimpleInterval("1", 1, 1000), readsSource), new SimpleInterval("1", 200, 250), true, true },
                { new LazyReadShard(new SimpleInterval("1", 200, 250), new SimpleInterval("1", 1, 1000), readsSource), new SimpleInterval("1", 190, 250), false, false },
                { new LazyReadShard(new SimpleInterval("1", 200, 250), new SimpleInterval("1", 1, 1000), readsSource), new SimpleInterval("1", 200, 260), false, true }
        };
    }

    @Test(dataProvider = "ShardContainsTestData")
    public void testShardContains(final LazyReadShard shard, final Locatable locatable, final boolean expectedIsContainedWithinShard, final boolean expectedStartsWithinShard ) {
    ...
    public Object[][] shardIterationTestData() {
        ...
        final LazyReadShard filteredShard = new LazyReadShard(new SimpleInterval("1", 200, 210), new SimpleInterval("1", 200, 210), readsSource);
        ...
        final LazyReadShard downsampledShard = new LazyReadShard(new SimpleInterval("1", 1, 5000), new SimpleInterval("1", 1, 5000), readsSource);
        downsampledShard.setDownsampler(readsBAndCOnlyDownsampler);

        return new Object[][] {
                { new LazyReadShard(new SimpleInterval("1", 200, 210), new SimpleInterval("1", 200, 210), readsSource), Arrays.asList("a", "b", "c") },
                { new LazyReadShard(new SimpleInterval("1", 200, 209), new SimpleInterval("1", 200, 209), readsSource), Arrays.asList("a", "b") },
                { new LazyReadShard(new SimpleInterval("1", 200, 204), new SimpleInterval("1", 200, 204), readsSource), Arrays.asList("a") },
                { new LazyReadShard(new SimpleInterval("1", 200, 204), new SimpleInterval("1", 190, 210), readsSource), Arrays.asList("a", "b", "c") },
                { new LazyReadShard(new SimpleInterval("1", 200, 204), new SimpleInterval("1", 200, 205), readsSource), Arrays.asList("a", "b") },
                { new LazyReadShard(new SimpleInterval("1", 400, 500), new SimpleInterval("1", 400, 500), readsSource), Collections.<String>emptyList() },
    ...
    @Test(dataProvider = "ShardIterationTestData")
    public void testShardLoadReads(final LazyReadShard shard, final List<String> expectedReadNames ) {
        final List<String> actualReadNames = new ArrayList<>();
    ...
    public Object[][] divideIntervalIntoShardsTestData() {
        ...
        return new Object[][] {
                // shardSize == 100, shardStep == 100, shardPadding == 0, start of contig
                {
                        ...
                        Arrays.asList(new LazyReadShard(new SimpleInterval("1", 1, 100), new SimpleInterval("1", 1, 100), readsSource))
                },

                // shardSize == 100, shardStep == 100, shardPadding == 10, start of contig
                {
                        new SimpleInterval("1", 1, 100), 100, 100, 10, readsSource, dictionary,
                        Arrays.asList(new LazyReadShard(new SimpleInterval("1", 1, 100), new SimpleInterval("1", 1, 110), readsSource))
                },

                // shardSize == 50, shardStep == 50, shardPadding == 0, start of contig
                {
                        new SimpleInterval("1", 1, 100), 50, 50, 0, readsSource, dictionary,
                        Arrays.asList(new LazyReadShard(new SimpleInterval("1", 1, 50), new SimpleInterval("1", 1, 50), readsSource),
                                      new LazyReadShard(new SimpleInterval("1", 51, 100), new SimpleInterval("1", 51, 100), readsSource))
                },

                // shardSize == 50, shardStep == 50, shardPadding == 10, start of contig
                {
                        new SimpleInterval("1", 1, 100), 50, 50, 10, readsSource, dictionary,
                        Arrays.asList(new LazyReadShard(new SimpleInterval("1", 1, 50), new SimpleInterval("1", 1, 60), readsSource),
                                      new LazyReadShard(new SimpleInterval("1", 51, 100), new SimpleInterval("1", 41, 110), readsSource))
                },

                // shardSize == 50, shardStep == 50, shardPadding == 0
                {
                        new SimpleInterval("1", 51, 200), 50, 50, 0, readsSource, dictionary,
                        Arrays.asList(new LazyReadShard(new SimpleInterval("1", 51, 100), new SimpleInterval("1", 51, 100), readsSource),
                                      new LazyReadShard(new SimpleInterval("1", 101, 150), new SimpleInterval("1", 101, 150), readsSource),
                                      new LazyReadShard(new SimpleInterval("1", 151, 200), new SimpleInterval("1", 151, 200), readsSource))
                },

                // shardSize == 50, shardStep == 50, shardPadding == 10
                {
                        new SimpleInterval("1", 51, 200), 50, 50, 10, readsSource, dictionary,
                        Arrays.asList(new LazyReadShard(new SimpleInterval("1", 51, 100), new SimpleInterval("1", 41, 110), readsSource),
                                      new LazyReadShard(new SimpleInterval("1", 101, 150), new SimpleInterval("1", 91, 160), readsSource),
                                      new LazyReadShard(new SimpleInterval("1", 151, 200), new SimpleInterval("1", 141, 210), readsSource))
                },

                // shardSize == 70, shardStep == 70, shardPadding == 0
                {
                        new SimpleInterval("1", 51, 200), 70, 70, 0, readsSource, dictionary,
                        Arrays.asList(new LazyReadShard(new SimpleInterval("1", 51, 120), new SimpleInterval("1", 51, 120), readsSource),
                                      new LazyReadShard(new SimpleInterval("1", 121, 190), new SimpleInterval("1", 121, 190), readsSource),
                                      new LazyReadShard(new SimpleInterval("1", 191, 200), new SimpleInterval("1", 191, 200), readsSource))
                },

                // shardSize == 70, shardStep == 70, shardPadding == 10
                {
                        new SimpleInterval("1", 51, 200), 70, 70, 10, readsSource, dictionary,
                        Arrays.asList(new LazyReadShard(new SimpleInterval("1", 51, 120), new SimpleInterval("1", 41, 130), readsSource),
                                      new LazyReadShard(new SimpleInterval("1", 121, 190), new SimpleInterval("1", 111, 200), readsSource),
                                      new LazyReadShard(new SimpleInterval("1", 191, 200), new SimpleInterval("1", 181, 210), readsSource))
                },
                ...
                // shardSize == 100, shardStep == 100, shardPadding == 10, end of contig
                {
                        ...
                        Arrays.asList(new LazyReadShard(new SimpleInterval("1", 15999, 16000), new SimpleInterval("1", 15989, 16000), readsSource))
                },

                // shardSize == 100, shardStep == 100, shardPadding == 0
                {
                        new SimpleInterval("1", 51, 300), 100, 100, 0, readsSource, dictionary,
                        Arrays.asList(new LazyReadShard(new SimpleInterval("1", 51, 150), new SimpleInterval("1", 51, 150), readsSource),
                                new LazyReadShard(new SimpleInterval("1", 151, 250), new SimpleInterval("1", 151, 250), readsSource),
                                new LazyReadShard(new SimpleInterval("1", 251, 300), new SimpleInterval("1", 251, 300), readsSource))
                },
                ...
                // shardSize == 100, shardStep == 50, shardPadding == 0
                {
                        ...
                        Arrays.asList(new LazyReadShard(new SimpleInterval("1", 51, 150), new SimpleInterval("1", 51, 150), readsSource),
                                new LazyReadShard(new SimpleInterval("1", 101, 200), new SimpleInterval("1", 101, 200), readsSource),
                                new LazyReadShard(new SimpleInterval("1", 151, 250), new SimpleInterval("1", 151, 250), readsSource),
                                new LazyReadShard(new SimpleInterval("1", 201, 300), new SimpleInterval("1", 201, 300), readsSource),
                                new LazyReadShard(new SimpleInterval("1", 251, 300), new SimpleInterval("1", 251, 300), readsSource))
                },
                ...
                // shardSize == 100, shardStep == 50, shardPadding == 10
                {
                        ...
                        Arrays.asList(new LazyReadShard(new SimpleInterval("1", 51, 150), new SimpleInterval("1", 41, 160), readsSource),
                                new LazyReadShard(new SimpleInterval("1", 101, 200), new SimpleInterval("1", 91, 210), readsSource),
                                new LazyReadShard(new SimpleInterval("1", 151, 250), new SimpleInterval("1", 141, 260), readsSource),
                                new LazyReadShard(new SimpleInterval("1", 201, 300), new SimpleInterval("1", 191, 310), readsSource),
                                new LazyReadShard(new SimpleInterval("1", 251, 300), new SimpleInterval("1", 241, 310), readsSource))
                },
                ...
                // shardSize == 100, shardStep == 25 shardPadding == 0
                {
                        ...
                        Arrays.asList(new LazyReadShard(new SimpleInterval("1", 51, 150), new SimpleInterval("1", 51, 150), readsSource),
                                new LazyReadShard(new SimpleInterval("1", 76, 175), new SimpleInterval("1", 76, 175), readsSource),
                                new LazyReadShard(new SimpleInterval("1", 101, 200), new SimpleInterval("1", 101, 200), readsSource),
                                new LazyReadShard(new SimpleInterval("1", 126, 225), new SimpleInterval("1", 126, 225), readsSource),
                                new LazyReadShard(new SimpleInterval("1", 151, 250), new SimpleInterval("1", 151, 250), readsSource),
                                new LazyReadShard(new SimpleInterval("1", 176, 275), new SimpleInterval("1", 176, 275), readsSource),
                                new LazyReadShard(new SimpleInterval("1", 201, 300), new SimpleInterval("1", 201, 300), readsSource),
                                new LazyReadShard(new SimpleInterval("1", 226, 300), new SimpleInterval("1", 226, 300), readsSource),
                                new LazyReadShard(new SimpleInterval("1", 251, 300), new SimpleInterval("1", 251, 300), readsSource),
                                new LazyReadShard(new SimpleInterval("1", 276, 300), new SimpleInterval("1", 276, 300), readsSource))
                },
                ...
                // shardSize == 100, shardStep == 25, shardPadding == 10
                {
                        ...
                        Arrays.asList(new LazyReadShard(new SimpleInterval("1", 51, 150), new SimpleInterval("1", 41, 160), readsSource),
                                new LazyReadShard(new SimpleInterval("1", 76, 175), new SimpleInterval("1", 66, 185), readsSource),
                                new LazyReadShard(new SimpleInterval("1", 101, 200), new SimpleInterval("1", 91, 210), readsSource),
                                new LazyReadShard(new SimpleInterval("1", 126, 225), new SimpleInterval("1", 116, 235), readsSource),
                                new LazyReadShard(new SimpleInterval("1", 151, 250), new SimpleInterval("1", 141, 260), readsSource),
                                new LazyReadShard(new SimpleInterval("1", 176, 275), new SimpleInterval("1", 166, 285), readsSource),
                                new LazyReadShard(new SimpleInterval("1", 201, 300), new SimpleInterval("1", 191, 310), readsSource),
                                new LazyReadShard(new SimpleInterval("1", 226, 300), new SimpleInterval("1", 216, 310), readsSource),
                                new LazyReadShard(new SimpleInterval("1", 251, 300), new SimpleInterval("1", 241, 310), readsSource),
                                new LazyReadShard(new SimpleInterval("1", 276, 300), new SimpleInterval("1", 266, 310), readsSource))
                }
        };
    }
    ...
    public void testDivideIntervalIntoShards( final SimpleInterval originalInterval, final int shardSize, final int shardStep, final int shardPadding, final ReadsDataSource readsSource, final SAMSequenceDictionary dictionary, List<Shard<GATKRead>> expectedShards  ) {
        ...
        final List<LazyReadShard> shards = (shardSize == shardStep) ?
                LazyReadShard.divideIntervalIntoShards(originalInterval, shardSize, shardPadding, readsSource, dictionary) :
                LazyReadShard.divideIntervalIntoShards(originalInterval, shardSize, shardStep, shardPadding, readsSource, dictionary);
