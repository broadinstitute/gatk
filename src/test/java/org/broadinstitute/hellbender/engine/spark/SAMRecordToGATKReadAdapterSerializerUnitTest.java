...
public class SAMRecordToGATKReadAdapterSerializerUnitTest {
    ...
    public void testSerializerRoundTripHeaderlessRead() {
        ...
        final GATKRead roundTrippedRead = SerializationTestUtils.roundTripInKryo(read, GATKRead.class, conf);
    ...
    public void testChangingContigsOnHeaderlessGATKRead(){
        ...
        final GATKRead roundTrippedRead2 = SerializationTestUtils.roundTripInKryo(read, GATKRead.class, conf);
