...
public class ReadsSparkSinkUnitTest extends BaseTest {
    ...
    public Object[][] loadReads() {
        ...
        return new Object[][]{
                {dir + "HiSeq.1mb.1RG.2k_lines.alternate.bam", "test1.bam"},
                {dir + "expected.HiSeq.1mb.1RG.2k_lines.bqsr.DIQ.alternate.bam", "test2.bam"},
        };
    }
    ...
    public void readsSinkTest(String inputBam, String outputFile) throws IOException {
        ...
        ReadsSparkSink.writeParallelReads(ctx, outputFile, rddParallelReads, header);
