...
public class MarkDuplicatesReadFilterTest {

    @Test
    public void testOpticalDuplicates() throws Exception {

        final MarkDuplicatesReadFilter filter = new MarkDuplicatesReadFilter(true);
    ...
    @Test
    public void testOpticalOrPCRDuplicates() throws Exception {

        final MarkDuplicatesReadFilter filter = new MarkDuplicatesReadFilter(false);
        final GATKRead read_in = ArtificialReadUtils.createArtificialRead("*");
