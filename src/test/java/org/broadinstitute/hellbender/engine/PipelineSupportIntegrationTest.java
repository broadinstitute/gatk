...
public class PipelineSupportIntegrationTest extends GATKBaseTest {
    ...
    public void testPipeForPicardTools() {
        ...
        BaseTest.runProcess(ProcessController.getThreadLocal(), new String[]{"/bin/sh","-c"," /gatk/gatk SortSam -I "+INPUT_BAM+" -O /dev/stdout -SO coordinate " +
                "| /gatk/gatk SetNmMdAndUqTags -I /dev/stdin -O "+ output.getAbsolutePath()+ " --CREATE_INDEX true -R "+b37_reference_20_21});//.split(" "));
