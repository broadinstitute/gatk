...
public class ExtractCohortLiteRemoveAnnotationsUnitTest extends GATKBaseTest{
    ...
    public void testRemoveAnnotations() {
        ...
        VariantContext expectedVC = ExtractCohortLiteEngine.removeAnnotations(variantContexts.get(0)); // single variantContext -- with annotations removed
