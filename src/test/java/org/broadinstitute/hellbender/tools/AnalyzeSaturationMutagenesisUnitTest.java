...
public class AnalyzeSaturationMutagenesisUnitTest extends GATKBaseTest {
    ...
    final private static CodonTracker codonTracker = new CodonTracker(orfCoords, refSeq);
    ...
    public void testWildTypeCodonCounts() {
        final CodonTracker codonTracker = new CodonTracker(orfCoords, refSeq);
    ...
    public void testVariantCodonCounts() {
        ...
        Assert.assertEquals(codonCounts[1][FRAME_PRESERVING_INDEL_INDEX], 1);
        Assert.assertEquals(codonCounts[2][6], 1);
        Assert.assertEquals(codonCounts[2][FRAME_PRESERVING_INDEL_INDEX], 1);
        Assert.assertEquals(codonCounts[2][FRAME_SHIFTING_INDEL_INDEX], 1);
    ...
    public void testWildTypeCodonValuesAndExons() {
        ...
        Assert.assertEquals(CodonTracker.parseReferenceIntoCodons(refSeq, exons), expectedCodonValues);
    }
    ...
    public void testReadReportFlanks() {
        ...
        final SingleReadReport readReport1 =
                new SingleReadReport(Collections.singletonList(new Interval(2,15)), snvList);
        ...
        final SingleReadReport readReport2 =
                new SingleReadReport(Collections.singletonList(new Interval(0,17)), snvList);
    ...
    public void testCombiningCoverage() {
        final SingleReadReport report1 = new SingleReadReport(Arrays.asList(
                new Interval(0, 9), new Interval(20, 40), new Interval(60,70), new Interval(100, 120)),
                Collections.emptyList());
        final SingleReadReport report2 = new SingleReadReport(Arrays.asList(
    ...
    public void testCombiningSNVLists() {
        ...
        final SingleReadReport report1 = new SingleReadReport(Collections.singletonList(new Interval(0, 32)), list1);
        final SingleReadReport report2 = new SingleReadReport(Collections.singletonList(new Interval(33, 60)), list2);
        ...
        final SingleReadReport report3 = new SingleReadReport(Collections.singletonList(new Interval(0, 35)), list1);
        final SingleReadReport report4 = new SingleReadReport(Collections.singletonList(new Interval(33, 60)), list2);
        ...
        final SingleReadReport report5 = new SingleReadReport(Collections.singletonList(new Interval(0, 36)), list1);
        final SingleReadReport report6 = new SingleReadReport(Collections.singletonList(new Interval(33, 60)), list2);
    ...
    public void testPairedApplication() {
        final HopscotchMap<SNVCollectionCount, Long, SNVCollectionCount> variationCounts =
                new HopscotchMap<>(10);
        final IntervalCounter intervalCounter = new IntervalCounter(60);
        ...
        pair1.apply(codonTracker, variationCounts, intervalCounter, 32);
        Assert.assertEquals(intervalCounter.countSpanners(0, 32), 1);
        Assert.assertEquals(intervalCounter.countSpanners(32, 33), 0);
        Assert.assertEquals(intervalCounter.countSpanners(33, 60), 1);

        // applied as one
        final SingleReadReport report3 = new SingleReadReport(Collections.singletonList(new Interval(0, 35)), list1);
        final SingleReadReport report4 = new SingleReadReport(Collections.singletonList(new Interval(33, 60)), list2);
        final PairedReadReport pair2 = new PairedReadReport(report3, report4);
        pair2.apply(codonTracker, variationCounts, intervalCounter, 60);
        Assert.assertEquals(intervalCounter.countSpanners(0, 32), 2);
        Assert.assertEquals(intervalCounter.countSpanners(32, 33), 1);
        Assert.assertEquals(intervalCounter.countSpanners(33, 60), 2);
    }
    ...
    public void testGetReadReport() {
        ...
        final GATKRead read = ArtificialReadUtils.createArtificialRead(header, "read1", 0, 1,
                                                                          bases, quals, "17M");
        ReadReport readReport = getReadReport(read, refSeq, readCounts);
        ...
        readReport = getReadReport(read, refSeq, readCounts);
