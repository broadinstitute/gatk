...
public class CalibrateDragstrModelIntegrationTest extends CommandLineProgramTest {
    ...
    // Asserting that there is no exception generated by the the ReadsDataSourceThreadPool cram code
    @Test()
    public void testReferenceGetsProvidedToCramInputWhenThreaded() throws IOException {
        ...
        args.add(CalibrateDragstrModel.STR_TABLE_PATH_FULL_NAME, EXPECTED_HUMAN_B37_20_21_TBL_GZ);
