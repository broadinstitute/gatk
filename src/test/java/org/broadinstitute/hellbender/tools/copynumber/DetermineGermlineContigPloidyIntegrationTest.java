...
public final class DetermineGermlineContigPloidyIntegrationTest extends CommandLineProgramTest {
    ...
    private static final File testContigPloidyPriorFile =
            new File(SIMULATED_DATA_DIR, "contig_ploidy_prior.tsv");
...
//    private static final File OUTPUT_DIR = createTempDir("test-ploidy");
    ...
    public void testCohort() {
        ...
        argsBuilder.addFileArgument(DetermineGermlineContigPloidy.CONTIG_PLOIDY_PRIORS_FILE_LONG_NAME, testContigPloidyPriorFile)
                .addArgument(StandardArgumentDefinitions.OUTPUT_LONG_NAME, OUTPUT_DIR.getAbsolutePath())
                .addArgument(CopyNumberStandardArgument.OUTPUT_PREFIX_LONG_NAME, "master-test-ploidy-cohort")
...
//        ANEUPLOIDY_COUNT_FILES.forEach(argsBuilder::addInput);
    ...
    public void testAneuploidyCaseFullPrior() {
        ...
        argsBuilder.addArgument(StandardArgumentDefinitions.OUTPUT_LONG_NAME, OUTPUT_DIR.getAbsolutePath())
                .addArgument(CopyNumberStandardArgument.OUTPUT_PREFIX_LONG_NAME, "master-test-aneuploidy-case-full")
                .addArgument(CopyNumberStandardArgument.MODEL_LONG_NAME,
                        new File(OUTPUT_DIR, "master-test-aneuploidy-cohort-full-model").getAbsolutePath())
                .addArgument(StandardArgumentDefinitions.VERBOSITY_NAME, "DEBUG");
        runCommandLine(argsBuilder);
    }
    ...
    public void testCase() {
        ...
        argsBuilder.addArgument(StandardArgumentDefinitions.OUTPUT_LONG_NAME, OUTPUT_DIR.getAbsolutePath())
                .addArgument(CopyNumberStandardArgument.OUTPUT_PREFIX_LONG_NAME, "master-test-ploidy-case")
                .addArgument(CopyNumberStandardArgument.MODEL_LONG_NAME,
                        new File(OUTPUT_DIR, "master-test-ploidy-cohort-model").getAbsolutePath())
                .addArgument(StandardArgumentDefinitions.VERBOSITY_NAME, "DEBUG");
        runCommandLine(argsBuilder);
    }
}