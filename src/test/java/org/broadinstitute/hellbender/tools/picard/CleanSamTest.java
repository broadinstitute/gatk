...
import org.broadinstitute.hellbender.utils.sam.testers.CleanSamTester;
...
public class CleanSamTest extends CommandLineProgramTest {
    private static final File TEST_DATA_DIR = new File("src/test/resources/org/broadinstitute/hellbender/tools/CleanSam");
