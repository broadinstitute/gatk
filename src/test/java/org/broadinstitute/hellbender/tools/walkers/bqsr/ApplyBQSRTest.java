...
public class ApplyBQSRTest extends CommandLineProgramTest {
    ...
    public void testPR(ABQSRTest params) throws IOException {
        WalkerTestSpec spec = new WalkerTestSpec(
                        " -I " + params.bam +
                        " -BQSR " + resourceDir + "HiSeq.20mb.1RG.table.gz" +
                        params.args +
                        " -O %s",
    ...
    public void testPRNoFailWithHighMaxCycle() throws IOException {
        WalkerTestSpec spec = new WalkerTestSpec(
                        " -I " + hiSeqBam +
                        " -BQSR " + resourceDir + "HiSeq.1mb.1RG.highMaxCycle.table.gz" +
                        " -O /dev/null",
    ...
    public void testPRFailWithLowMaxCycle() throws IOException {
        WalkerTestSpec spec = new WalkerTestSpec(
                        " -I " + hiSeqBam +
                        " -BQSR " + resourceDir + "HiSeq.1mb.1RG.lowMaxCycle.table.gz" +
                        " -O /dev/null",
                0,
                UserException.class);
