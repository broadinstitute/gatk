 ...
 */
public final class BaseRecalibratorDataflow2IntegrationTest extends CommandLineProgramTest {
    ...
    public static void main(String[] args) throws Exception {
        new BaseRecalibratorDataflow2IntegrationTest().runAllTests();
    }
    ...
    private static class BQSRTest {
        ...
        public String getCommandLine() {
            return  " -apiref gg://reference/" + referenceSetID +
                    " -I " + bam +
                    " " + args +
    ...
    public Object[][] createBQSRTestData() {
        ...
        //final String GRCh37RefLite = "EJjur6DxjIa6KQ"; // that's the "lite" version
        final String GRCh37Ref = "EOSsjdnTicvzwAE"; // that's the "full" version
    ...
    public Object[][] createBQSRTestDataBucket() {
        final String apiArgs = "--apiKey " + getDataflowTestApiKey() + " --project " + getDataflowTestProject();
        final String GRCh37Ref = "EOSsjdnTicvzwAE";
        final String localResources =  getResourceDir();
    ...
    public void testPlottingWorkflow() throws IOException {
        ...
        final String argPre = cloudArgs
                + " -apiref gg://reference/" + GRCh37Ref + " -BQSRKnownVariants " + dbSNPb37 + " -I " + HiSeqBam
