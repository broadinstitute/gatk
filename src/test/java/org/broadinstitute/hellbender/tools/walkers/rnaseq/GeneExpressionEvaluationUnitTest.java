...
public class GeneExpressionEvaluationUnitTest extends GATKBaseTest {
    ...
    public Object[][] testMultiOverlapMethodDataProvider() {
        ...
        */
        ...
        final Gff3BaseData gene1 = new Gff3BaseData("theContig", ".", "gene", 150, 450, Strand.POSITIVE, 0, Collections.singletonMap("ID", "gene1"));
        final Gff3BaseData gene2 = new Gff3BaseData("theContig", ".", "gene", 225, 600, Strand.POSITIVE, 0, Collections.singletonMap("ID", "gene2"));
        final Gff3BaseData gene3 = new Gff3BaseData("theContig", ".", "gene", 100, 410, Strand.POSITIVE, 0, Collections.singletonMap("ID", "gene3"));
