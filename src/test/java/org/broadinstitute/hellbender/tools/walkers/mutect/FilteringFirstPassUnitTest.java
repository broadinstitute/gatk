...
public class FilteringFirstPassUnitTest extends GATKBaseTest {
    ...
    public Object[][] makeFalsePositiveRateData() {
        return new Object[][]{
                ...
                {new double[]{0.01, 0.01, 0.01, 0.01, 0.01}, 0.05, 1.0}, // The FPR never exceeds the max FPR so do not filterSuffix
                {new double[]{0.99, 0.99, 0.99, 1.0, 1.0}, 0.05, 0.0}, // Impossible to meet the FPR with this data so filterSuffix everything
