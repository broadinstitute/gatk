...
//            logger.warn("result at " + i + " is " + current);
    ...
    private class RefConfData {
        ...
        private RefConfData(String ref, int extension) {
            ...
            refLoc = parser.createGenomeLoc("1", getStart(), getEnd());
            paddedRefLoc = parser.createGenomeLoc("1", getStart() - extension, getEnd() + extension);
            region = new AssemblyRegion(getRefLoc(), parser, extension, header);
