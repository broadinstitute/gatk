...
public class HaplotypeCallerIntegrationTest extends CommandLineProgramTest {
    ...
    public void testThisLargeCaseInDebugger() {
        final String[] args = ("-I /Users/emeryj/hellbender/Scripts/HaplotypeCallerSpark/G96832.NA12878.chr15.bam -R /Users/emeryj/hellbender/gatk/src/test/resources/large/Homo_sapiens_assembly19.fasta.gz -O "+createTempFile("output", ".vcf")+" -L 15:20207800-20208000 --debug-haplotype-discovery --haplotype-debug-histogram-output histogram.JT.txt -ERC GVCF --smith-waterman FASTEST_AVAILABLE --disable-sequence-graph-simplification").split(" ");
        runCommandLine(args);
    }
