...
public abstract class AbstractBaseRecalibratorIntegrationTest extends CommandLineProgramTest {

    public static class BQSRTest {
        public final String reference;
        public final String bam;
        public final String knownSites;
        public final String args;
        public final String expectedFileName;

        public BQSRTest(String reference, String bam, String knownSites, String args, String expectedFileName) {
