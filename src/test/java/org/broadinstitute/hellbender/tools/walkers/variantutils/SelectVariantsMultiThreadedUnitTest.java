...
public class SelectVariantsMultiThreadedUnitTest extends GATKBaseTest {
    ...
    public void maxIndelSizeTest(final int size, final int otherSize, final int max, final int min, final String op) {
        ...
        final boolean hasIndelTooLargeOrSmall = SelectVariantsMultiThreaded.containsIndelLargerOrSmallerThan(vc, max, min);
