        ...
        return new Object[][]{
            ...
            {new File(MarkDuplicatesIntegrationTest.TEST_DATA_DIR,"example.chr1.1-1K.unmarkedDups.noDups.bam"), 20, 0,
             ImmutableMap.of("Solexa-16419", ImmutableList.of(0L, 3L, 0L, 0L, 0L, 0L, 0.0, 0L),
                             "Solexa-16416", ImmutableList.of(1L, 1L, 0L, 0L, 0L, 0L, 0.0, 0L),
                             "Solexa-16404", ImmutableList.of(5L, 1L, 0L, 0L, 0L, 0L, 0.0, 0L),
            ...
            {new File(MarkDuplicatesIntegrationTest.TEST_DATA_DIR,"example.chr1.1-1K.unmarkedDups.bam"), 90, 6,
             ImmutableMap.of("Solexa-16419", ImmutableList.of(7L, 3L, 4L, 0L, 0L, 0L, 0.0, 0L),
                             "Solexa-16416", ImmutableList.of(3L, 2L, 2L, 0L, 0L, 0L, 0.0, 0L),
                             "Solexa-16404", ImmutableList.of(5L, 8L, 3L, 0L, 2L, 0L, 0.190476, 13L),
                             "Solexa-16406", ImmutableList.of(3L, 9L, 1L, 0L, 0L, 0L, 0.0, 0L),
