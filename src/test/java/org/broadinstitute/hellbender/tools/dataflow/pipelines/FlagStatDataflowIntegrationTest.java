...
public final class FlagStatDataflowIntegrationTest extends DataflowCommandLineProgramTest {


    @Test( groups = {"bucket_todo", "dataflow_todo"})
    public void flagStatDataflowLocalReadFromBucket() throws IOException {
        List<String> args = new ArrayList<>();
        args.add("--apiKey"); args.add(getGCPTestApiKey());
        args.add("--project"); args.add(getGCPTestProject());
        args.add("--"+ StandardArgumentDefinitions.INPUT_LONG_NAME); args.add( getGCPTestInputPath() + "org/broadinstitute/hellbender/tools/dataflow/FlagStatDataflow/flag_stat.bam");
