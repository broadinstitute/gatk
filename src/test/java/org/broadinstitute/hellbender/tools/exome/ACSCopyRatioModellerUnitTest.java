...
/**
 * Unit tests for {@link ACSCopyRatioModeller}.
 * <p>
...
public final class ACSCopyRatioModellerUnitTest extends BaseTest {
    ...
    public void testRunMCMCOnCopyRatioSegmentedModel() {
        ...
        //run MCMC
        final ACSCopyRatioModeller modeller = new ACSCopyRatioModeller(segmentedModel);
        ...
        final List<ACSCopyRatioModeller.OutlierIndicators> outlierIndicatorSamples =
        ...
        for (int target = 0; target < targetCoverages.size(); target++) {
            ...
            for (ACSCopyRatioModeller.OutlierIndicators sample : outlierIndicatorSamples) {
