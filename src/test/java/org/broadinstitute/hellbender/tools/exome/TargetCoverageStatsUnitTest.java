...
public final class TargetCoverageStatsUnitTest extends BaseTest {
    ...
    public void testCreation() {
        final TargetCoverageStats subject = new TargetCoverageStats(new Target("TARGET"), 1.2, 12.2);
    ...
    public void testNullTarget() {
        new TargetCoverageStats(null, 1.2, 12.2);
    }

    @Test
    public void testNaNStats() {
        final TargetCoverageStats subject = new TargetCoverageStats(new Target("TARGET"), Double.NaN, Double.NaN);
        Assert.assertEquals(subject.target, new Target("TARGET"));
