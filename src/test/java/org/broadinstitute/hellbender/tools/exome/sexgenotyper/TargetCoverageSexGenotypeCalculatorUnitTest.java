...
public class TargetCoverageSexGenotypeCalculatorUnitTest extends BaseTest {
    ...
    private static final double MIN_BAIT_COUNT = TargetCoverageSexGenotypeCalculator.MIN_ALLOWED_BAIT_COUNT_PER_TARGET + 1.0;
    private static final double MAX_BAIT_COUNT = 100.0;
    private static final int MIN_TARGETS_PER_CONTIG = 10;
    private static final int MAX_TARGETS_PER_CONTIG = 20;
    private static final int MAX_TARGET_LENGTH = 1000;
    private static final int MAX_TARGET_SPACING = 1000;
    private static final double MIN_READ_DEPTH = 200.0;
    private static final double MAX_READ_DEPTH = 500.0;
