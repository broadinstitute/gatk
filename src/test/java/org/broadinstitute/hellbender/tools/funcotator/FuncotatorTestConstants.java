...
public class FuncotatorTestConstants {
    public static final String FUNCOTATOR_TEST_DIR = BaseTest.toolsTestDir + "funcotator" + File.separator;

    public static final String HG19_CHR19_REFERENCE_FILE_NAME = BaseTest.largeFileTestDir + "funcotator" + File.separator + "GRCh37.p13.chr19.fasta";
    public static final String HG19_CHR3_REFERENCE_FILE_NAME = BaseTest.largeFileTestDir + "funcotator" + File.separator + "GRCh37.p13.chr3.fasta";
    ...
    public static final String GTF_CHR3_FILE_NAME = BaseTest.largeFileTestDir + "funcotator" + File.separator + "gencode.v19.chr_patch_hapl_scaff.chr3.gtf";

    public static final String GENCODE_TRANSCRIPT_FASTA_FILE_NAME = BaseTest.largeFileTestDir + "funcotator" + File.separator + "gencode.v19.pc_transcripts.fasta";
