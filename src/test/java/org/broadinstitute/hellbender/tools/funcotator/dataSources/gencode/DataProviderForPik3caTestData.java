...
//                new Object[] { "PIK3CA", 3, 178948159, 178948168, GencodeFuncotation.VariantClassification.SPLICE_SITE,     GencodeFuncotation.VariantType.DEL, "TGAGAGGTGA", "T",     "g.chr3:178948160_178948168delGAGAGGTGA", "+", "c.2932_2936delGAGAGGTGA", "c.(2932-2937)gagagg>g",   "p.ER978del" }
    ...
    public static List<Object[]> providePik3caInDelData2() {
        ...
        return Arrays.asList(
                /*Fails, but really OK - change GT*/new Object[] { "PIK3CA", 3, 178916621, 178916621, GencodeFuncotation.VariantClassification.IN_FRAME_INS,    GencodeFuncotation.VariantType.INS, "C",       "CTAT",       "g.chr3:178916621_178916622insTAT",       "+", "c.8_9insTAT",        "c.(7-12)ccacga>ccTATacga",  "p.3_4PR>PIR" },
                ...
                /*PROBLEM*/new Object[] { "PIK3CA", 3, 178916620, 178916620, GencodeFuncotation.VariantClassification.IN_FRAME_INS,    GencodeFuncotation.VariantType.INS, "C",       "CTAT",       "g.chr3:178916620_178916621insTAT",       "+", "c.7_8insTAT",        "c.(7-9)cca>cTATca",         "p.3_3P>LS" },
                ...
                /*PROBLEM - prot change / codon change not quite right*/new Object[] { "PIK3CA", 3, 178916621, 178916621, GencodeFuncotation.VariantClassification.FRAME_SHIFT_INS, GencodeFuncotation.VariantType.INS, "C",       "CTA",        "g.chr3:178916621_178916622insTA",        "+", "c.8_9insTA",         "c.(7-12)ccacgafs",          "p.R4fs" },
                ...
                /*PROBLEM - prot change / codon change not quite right*/new Object[] { "PIK3CA", 3, 178916621, 178916621, GencodeFuncotation.VariantClassification.FRAME_SHIFT_INS, GencodeFuncotation.VariantType.INS, "C",       "CT",         "g.chr3:178916621_178916622insT",         "+", "c.8_9insT",          "c.(7-12)ccacgafs",          "p.R4fs" },
                ...
                /*PROBLEM - prot change / codon change not quite right*/new Object[] { "PIK3CA", 3, 178916621, 178916621, GencodeFuncotation.VariantClassification.FRAME_SHIFT_INS, GencodeFuncotation.VariantType.INS, "C",       "CTATT",      "g.chr3:178916621_178916622insTATT",      "+", "c.8_9insTATT",       "c.(7-12)ccacgafs",          "p.R4fs" },
                ...
                /*Fails, but really OK - change GT*/new Object[] { "PIK3CA", 3, 178916619, 178916622, GencodeFuncotation.VariantClassification.IN_FRAME_DEL,    GencodeFuncotation.VariantType.DEL, "TCCA",     "T",         "g.chr3:178916620_178916622delCCA",       "+", "c.7_9delCCA",        "c.(7-9)ccadel",             "p.P3del" },
                /*PROBLEM*/new Object[] { "PIK3CA", 3, 178916620, 178916623, GencodeFuncotation.VariantClassification.IN_FRAME_DEL,    GencodeFuncotation.VariantType.DEL, "CCAC",     "C",         "g.chr3:178916621_178916623delCAC",       "+", "c.8_10delCAC",       "c.(7-12)ccacga>cga",        "p.P3del" },
                /*PROBLEM - codon change when deleting 3 bases out of frame*/new Object[] { "PIK3CA", 3, 178916621, 178916624, GencodeFuncotation.VariantClassification.IN_FRAME_DEL,    GencodeFuncotation.VariantType.DEL, "CACG",     "C",         "g.chr3:178916622_178916624delACG",       "+", "c.9_11delACG",       "c.(7-12)ccacga>cca",        "p.R4del" },

                /*Fails, but really OK - change GT*/new Object[] { "PIK3CA", 3, 178916618, 178916620, GencodeFuncotation.VariantClassification.FRAME_SHIFT_DEL, GencodeFuncotation.VariantType.DEL, "CTC",      "C",         "g.chr3:178916619_178916620delTC",        "+", "c.6_7delTC",         "c.(4-9)cctccafs",           "p.PP2fs" },
                ...
                /*PROBLEM*/new Object[] { "PIK3CA", 3, 178916620, 178916622, GencodeFuncotation.VariantClassification.FRAME_SHIFT_DEL, GencodeFuncotation.VariantType.DEL, "CCA",      "C",         "g.chr3:178916621_178916622delCA",        "+", "c.8_9delCA",         "c.(7-9)ccafs",              "p.P3fs" },

                // Need to qualify these:
                /*PROBLEM - this is off by 1 codon*/new Object[] { "PIK3CA", 3, 178916621, 178916623, GencodeFuncotation.VariantClassification.FRAME_SHIFT_DEL, GencodeFuncotation.VariantType.DEL, "CAC",      "C",         "g.chr3:178916622_178916623delAC",        "+", "c.9_10delAC",        "c.(7-12)ccacgafs",          "p.R4fs" },
                /*PROBLEM - genome change, cdna change, codon change, protein change have issues*/new Object[] { "PIK3CA", 3, 178916618, 178916619, GencodeFuncotation.VariantClassification.FRAME_SHIFT_DEL, GencodeFuncotation.VariantType.DEL, "CT",       "C",         "g.chr3:178916619delT",                   "+", "c.6delT",            "c.(4-6)cctfs",              "p.P3fs" },
                /*PROBLEM - genome change and cdna change show 2 locations, but they're the same location*/new Object[] { "PIK3CA", 3, 178916619, 178916620, GencodeFuncotation.VariantClassification.FRAME_SHIFT_DEL, GencodeFuncotation.VariantType.DEL, "TC",       "T",         "g.chr3:178916620delC",                   "+", "c.7delC",            "c.(7-9)ccafs",              "p.P3fs" },
                /*PROBLEM - genome change, cdna change, codon change, protein change have issues*/new Object[] { "PIK3CA", 3, 178916620, 178916621, GencodeFuncotation.VariantClassification.FRAME_SHIFT_DEL, GencodeFuncotation.VariantType.DEL, "CC",       "C",         "g.chr3:178916621delC",                   "+", "c.8delC",            "c.(7-9)ccafs",              "p.P3fs" },
                /*PROBLEM - genome change, cdna change, codon change, protein change have issues*/new Object[] { "PIK3CA", 3, 178916621, 178916622, GencodeFuncotation.VariantClassification.FRAME_SHIFT_DEL, GencodeFuncotation.VariantType.DEL, "CA",       "C",         "g.chr3:178916622delA",                   "+", "c.9delA",            "c.(7-9)ccafs",              "p.P3fs" },
                /*PROBLEM - Protein change technically correct, codon change is slightly weird*/new Object[] { "PIK3CA", 3, 178916618, 178916622, GencodeFuncotation.VariantClassification.FRAME_SHIFT_DEL, GencodeFuncotation.VariantType.DEL, "CTCCA",    "C",         "g.chr3:178916619_178916622delTCCA",      "+", "c.6_9delTCCA",       "c.(4-9)cctccafs",           "p.PP2fs" },
                new Object[] { "PIK3CA", 3, 178916619, 178916623, GencodeFuncotation.VariantClassification.FRAME_SHIFT_DEL, GencodeFuncotation.VariantType.DEL, "TCCAC",    "T",         "g.chr3:178916620_178916623delCCAC",      "+", "c.7_10delCCAC",      "c.(7-12)ccacgafs",          "p.PR3fs" },
                /*PROBLEM - Protein change is wrong - first bad protein is P3*/new Object[] { "PIK3CA", 3, 178916620, 178916624, GencodeFuncotation.VariantClassification.FRAME_SHIFT_DEL, GencodeFuncotation.VariantType.DEL, "CCACG",    "C",         "g.chr3:178916621_178916624delCACG",      "+", "c.8_11delCACG",      "c.(7-12)ccacgafs",          "p.PR3fs" },
                /*PROBLEM - codon change is wrong - not sure what to do about cases like this - must ask lee*/new Object[] { "PIK3CA", 3, 178916621, 178916625, GencodeFuncotation.VariantClassification.FRAME_SHIFT_DEL, GencodeFuncotation.VariantType.DEL, "CACGA",    "C",         "g.chr3:178916622_178916625delACGA",      "+", "c.9_12delACGA",      "c.(7-12)ccacgafs",          "p.PR3fs" },
                /*PROBLEM - Same as above*/new Object[] { "PIK3CA", 3, 178916618, 178916625, GencodeFuncotation.VariantClassification.FRAME_SHIFT_DEL, GencodeFuncotation.VariantType.DEL, "CTCCACGA", "C",         "g.chr3:178916619_178916625delTCCACGA",   "+", "c.6_12delTCCACGA",   "c.(4-12)cctccacgafs",       "p.PPR2fs" },
                new Object[] { "PIK3CA", 3, 178916619, 178916626, GencodeFuncotation.VariantClassification.FRAME_SHIFT_DEL, GencodeFuncotation.VariantType.DEL, "TCCACGAC", "T",         "g.chr3:178916620_178916626delCCACGAC",   "+", "c.7_13delCCACGAC",   "c.(7-15)ccacgaccafs",       "p.PRP3fs" },
                /*PROBLEM - Same as last problem*/new Object[] { "PIK3CA", 3, 178916620, 178916627, GencodeFuncotation.VariantClassification.FRAME_SHIFT_DEL, GencodeFuncotation.VariantType.DEL, "CCACGACC", "C",         "g.chr3:178916621_178916627delCACGACC",   "+", "c.8_14delCACGACC",   "c.(7-15)ccacgaccafs",       "p.PRP3fs" },
                /*PROBLEM - Same as last problem*/new Object[] { "PIK3CA", 3, 178916621, 178916628, GencodeFuncotation.VariantClassification.FRAME_SHIFT_DEL, GencodeFuncotation.VariantType.DEL, "CACGACCA", "C",         "g.chr3:178916622_178916628delACGACCA",   "+", "c.9_15delACGACCA",   "c.(7-15)ccacgaccafs",       "p.PRP3fs" }
            );
    }
}
