...
public final class BaseRecalibratorSparkIntegrationTest extends CommandLineProgramTest {
    ...
    public Object[][] createBQSRTestData() {
        ...
        return new Object[][]{
                ...
                // local input/computation/reference, BROADCAST
                ...
                {new BQSRTest(GRCh37Ref2bit_chr2021, hiSeqBam_chr20, dbSNPb37_chr20, "--joinStrategy BROADCAST --mismatches_context_size 4", getResourceDir() + BQSRTestData.EXPECTED_WGS_B37_CH20_1M_1M1K_MISMATCHES_CONTEXT_SIZE_4_RECAL)},
                // multiple known sites with 2bit BROADCAST
                ...
                //{new BQSRTest(GRCh37Ref2bit_chr2021, hiSeqCram_20_21_100000, more20Sites, " -knownSites " + more21Sites, getResourceDir() + "expected.CEUTrio.HiSeq.WGS.b37.ch20.ch21.10m-10m100.recal.txt")},
