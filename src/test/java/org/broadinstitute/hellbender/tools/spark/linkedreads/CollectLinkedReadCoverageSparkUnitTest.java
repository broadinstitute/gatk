...
public class CollectLinkedReadCoverageSparkUnitTest {
    ...
    public void testAddReadToIntervals() {
        ...
        final CollectLinkedReadCoverageSpark.MySVIntervalTree intervals = new CollectLinkedReadCoverageSpark.MySVIntervalTree();
        ...
        final CollectLinkedReadCoverageSpark.MySVIntervalTree svIntervalTree = CollectLinkedReadCoverageSpark.addReadToIntervals(intervals, new ReadInfo(readMetadata, read1), 1000);

        final SVIntervalTree.Entry<List<ReadInfo>> node = svIntervalTree.myTree.find(new SVInterval(readMetadata.getContigID("1"), 1750, 1849));
        ...
        final CollectLinkedReadCoverageSpark.MySVIntervalTree svIntervalTree2 = CollectLinkedReadCoverageSpark.addReadToIntervals(intervals, new ReadInfo(readMetadata, read2), 1000);
        final SVIntervalTree.Entry<List<ReadInfo>> node2 = svIntervalTree2.myTree.find(new SVInterval(readMetadata.getContigID("1"), 1750, 1999));
        ...
        final CollectLinkedReadCoverageSpark.MySVIntervalTree stringSVIntervalTree3 = CollectLinkedReadCoverageSpark.addReadToIntervals(intervals, new ReadInfo(readMetadata, read3), 1000);
        final SVIntervalTree.Entry<List<ReadInfo>> node3 = stringSVIntervalTree3.myTree.find(new SVInterval(readMetadata.getContigID("1"), 1750, 1999));
        ...
        final SVIntervalTree.Entry<List<ReadInfo>> node4 = stringSVIntervalTree3.myTree.find(new SVInterval(readMetadata.getContigID("1"), 3500, 3599));
        ...
        final CollectLinkedReadCoverageSpark.MySVIntervalTree svIntervalTree4 = CollectLinkedReadCoverageSpark.addReadToIntervals(intervals, new ReadInfo(readMetadata, read4), 2500);
        final SVIntervalTree.Entry<List<ReadInfo>> node5 = svIntervalTree4.myTree.find(new SVInterval(readMetadata.getContigID("1"), 1750, 1999));
        Assert.assertNotNull(node5);
        Assert.assertEquals(node5.getValue().size(), 2);

        final SVIntervalTree.Entry<List<ReadInfo>> node6 = svIntervalTree4.myTree.find(new SVInterval(readMetadata.getContigID("2"), 500, 599));
    ...
    public void testMergeSVIntervalTrees() {
        ...
        tree1.myTree.put(new SVInterval(readMetadata.getContigID("1"), 3000, 3100), resultList2);
        ...
        tree2.myTree.put(new SVInterval(readMetadata.getContigID("1"), 1500, 1649), resultList3);
        ...
        tree2.myTree.put(new SVInterval(readMetadata.getContigID("1"), 3300, 3500), resultList4);

        final CollectLinkedReadCoverageSpark.MySVIntervalTree mergedTree = CollectLinkedReadCoverageSpark.mergeIntervalTrees(tree1, tree2, 250);
        Assert.assertEquals(mergedTree.myTree.size(), 2);
        final SVIntervalTree.Entry<List<ReadInfo>> mergedNode1 = mergedTree.myTree.find(new SVInterval(readMetadata.getContigID("1"), 1000, 1649));
        ...
        final SVIntervalTree.Entry<List<ReadInfo>> mergedNode2 = mergedTree.myTree.find(new SVInterval(readMetadata.getContigID("1"), 3000, 3500));
    ...
    public void testSerializeTree() {
        final SAMFileHeader artificialSamHeader = ArtificialReadUtils.createArtificialSamHeader(1, 1, 10000);
        final ReadMetadata readMetadata = new ReadMetadata(Collections.emptySet(), ArtificialReadUtils.createArtificialSamHeader(), null, 1, 1, 1, 30);
        final CollectLinkedReadCoverageSpark.MySVIntervalTree tree = new CollectLinkedReadCoverageSpark.MySVIntervalTree(createTestSVIntervalTree1(artificialSamHeader, readMetadata));
        ...
        Assert.assertEquals(tree.myTree.size(), tree2.myTree.size());
        final SVIntervalTree.Entry<List<ReadInfo>> listEntry = tree2.myTree.find(new SVInterval(readMetadata.getContigID("1"), 1000, 1160));
