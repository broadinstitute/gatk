...
public class ChimericAlignmentUnitTest {
    ...
    public void testGetLeftAlignedLeftBreakpointOnAssembledContig() throws Exception {
        ...
        Assert.assertEquals(chimericAlignment.getLeftJustifiedBreakpoints()._1(), new SimpleInterval("1", 200, 200));
    }
    ...
    public void testAlignedBreakpointBreakpointAllele() throws Exception {
        ...
        final SimpleInterval leftAlignedLeftBreakpointOnAssembledContig = chimericAlignment.getLeftJustifiedBreakpoints()._1();
        Assert.assertEquals(leftAlignedLeftBreakpointOnAssembledContig, new SimpleInterval("8", 108569294, 108569294));
        final SimpleInterval leftAlignedRightBreakpointOnAssembledContig = chimericAlignment.getLeftJustifiedBreakpoints()._2();
