...
public class AnnotatedVariantProducerUnitTest extends BaseTest {
    ...
    public void testGetType() throws IOException {
        ...
        seeIfItWorks_typeInference(breakpoints, SvType.TYPES.DEL.name(), ImmutableSet.of(StructuralVariationDiscoveryArgumentCollection.DiscoveryStepConstants.TANDUP_CONTRACTION_STRING));
        ...
        seeIfItWorks_typeInference(breakpoints, SvType.TYPES.DUP.name(), ImmutableSet.of(StructuralVariationDiscoveryArgumentCollection.DiscoveryStepConstants.TANDUP_EXPANSION_STRING));
    ...
    public void testIntegrative() throws IOException {
        ...
        seeIfItWorks_integrative(testData, Stream.concat( commonAttributes.stream(),
                Sets.newHashSet(StructuralVariationDiscoveryArgumentCollection.DiscoveryStepConstants.TANDUP_CONTRACTION_STRING, GATKSVVCFHeaderLines.DUP_REPET_UNIT_REF_SPAN, GATKSVVCFHeaderLines.DUPLICATION_NUMBERS, GATKSVVCFHeaderLines.HOMOLOGY, GATKSVVCFHeaderLines.HOMOLOGY_LENGTH).stream())
                .sorted().collect(Collectors.toList()));
        ...
        seeIfItWorks_integrative(testData, Stream.concat( commonAttributes.stream(),
                Sets.newHashSet(StructuralVariationDiscoveryArgumentCollection.DiscoveryStepConstants.TANDUP_EXPANSION_STRING, GATKSVVCFHeaderLines.DUP_REPET_UNIT_REF_SPAN, GATKSVVCFHeaderLines.DUP_SEQ_CIGARS, GATKSVVCFHeaderLines.DUPLICATION_NUMBERS).stream())
                .sorted().collect(Collectors.toList()));
        ...
        seeIfItWorks_integrative(testData, Stream.concat( commonAttributes.stream(),
                Sets.newHashSet(StructuralVariationDiscoveryArgumentCollection.DiscoveryStepConstants.TANDUP_EXPANSION_STRING, GATKSVVCFHeaderLines.DUP_REPET_UNIT_REF_SPAN, GATKSVVCFHeaderLines.DUP_SEQ_CIGARS, GATKSVVCFHeaderLines.DUPLICATION_NUMBERS, GATKSVVCFHeaderLines.INSERTED_SEQUENCE).stream())
                .sorted().collect(Collectors.toList()));
        ...
        seeIfItWorks_integrative(testData, Stream.concat( commonAttributes.stream(),
                Sets.newHashSet(StructuralVariationDiscoveryArgumentCollection.DiscoveryStepConstants.TANDUP_EXPANSION_STRING, GATKSVVCFHeaderLines.DUP_REPET_UNIT_REF_SPAN, GATKSVVCFHeaderLines.DUPLICATION_NUMBERS, GATKSVVCFHeaderLines.DUP_ANNOTATIONS_IMPRECISE, GATKSVVCFHeaderLines.HOMOLOGY, GATKSVVCFHeaderLines.HOMOLOGY_LENGTH).stream())
                .sorted().collect(Collectors.toList()));
        ...
        seeIfItWorks_integrative(testData, Stream.concat( commonAttributes.stream(),
                Sets.newHashSet(StructuralVariationDiscoveryArgumentCollection.DiscoveryStepConstants.TANDUP_CONTRACTION_STRING, GATKSVVCFHeaderLines.DUP_REPET_UNIT_REF_SPAN, GATKSVVCFHeaderLines.DUPLICATION_NUMBERS, GATKSVVCFHeaderLines.DUP_ANNOTATIONS_IMPRECISE, GATKSVVCFHeaderLines.HOMOLOGY, GATKSVVCFHeaderLines.HOMOLOGY_LENGTH).stream())
                .sorted().collect(Collectors.toList()));
