...
public class SvTypeInferenceUnitTest extends BaseTest {
    ...
    public void testGetType() throws IOException {
        ...
        seeIfItWorks_typeInference(breakpoints, SvType.TYPES.DEL.name(), ImmutableSet.of(GATKSVVCFHeaderLines.TANDUP_CONTRACTION_STRING));
        ...
        seeIfItWorks_typeInference(breakpoints, SvType.TYPES.DUP.name(), ImmutableSet.of(GATKSVVCFHeaderLines.TANDUP_EXPANSION_STRING));
