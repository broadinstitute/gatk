...
public class SVTypeUnitTest {
    ...
    private static void worker(final NovelAdjacencyReferenceLocations novelAdjacencyReferenceLocations,
        ...
        final String[] fields = variantId.split(GATKSVVCFHeaderLines.VARIANT_ID_FIELD_SEPARATOR);
    ...
    public void testAltAlleleSvLenAndIdProductions() throws IOException {
        ...
        // inversion
        worker(SVDiscoveryTestDataProvider.forSimpleInversionFromLongCtg1WithStrangeLeftBreakpoint._3(), GATKSVVCFHeaderLines.VCF_ALT_ALLELE_STRING_INV, 14644,
                GATKSVVCFHeaderLines.INV33);
        worker(SVDiscoveryTestDataProvider.forSimpleInversionWithHom_leftPlus._3(), GATKSVVCFHeaderLines.VCF_ALT_ALLELE_STRING_INV, 405,
                GATKSVVCFHeaderLines.INV55);

        // simple deletion
        worker(SVDiscoveryTestDataProvider.forSimpleDeletion_plus._3(), GATKSVVCFHeaderLines.VCF_ALT_ALLELE_STRING_DEL, -20,
                SvType.TYPES.DEL.name());

        // simple insertion
        worker(SVDiscoveryTestDataProvider.forSimpleInsertion_minus._3(), GATKSVVCFHeaderLines.VCF_ALT_ALLELE_STRING_INS, 50,
                SvType.TYPES.INS.name());

        // long range substitution (i.e. scarred deletion)
        worker(SVDiscoveryTestDataProvider.forLongRangeSubstitution_plus._3(), GATKSVVCFHeaderLines.VCF_ALT_ALLELE_STRING_DEL, -20,
                SvType.TYPES.DEL.name());

        // simple deletion with homology
        worker(SVDiscoveryTestDataProvider.forDeletionWithHomology_minus._3(), GATKSVVCFHeaderLines.VCF_ALT_ALLELE_STRING_DEL, -38,
                SvType.TYPES.DEL.name());

        // simple tandem dup contraction from 2 units to 1 unit
        worker(SVDiscoveryTestDataProvider.forSimpleTanDupContraction_plus._3(), GATKSVVCFHeaderLines.VCF_ALT_ALLELE_STRING_DEL, -10,
                GATKSVVCFHeaderLines.TANDUP_CONTRACTION_ID_START_STRING);

        // simple tandem dup expansion from 1 unit to 2 units
        worker(SVDiscoveryTestDataProvider.forSimpleTanDupExpansion_minus._3(), GATKSVVCFHeaderLines.VCF_ALT_ALLELE_STRING_DUP, 10,
                GATKSVVCFHeaderLines.TANDUP_EXPANSION_ID_START_STRING);

        // simple tandem dup expansion from 1 unit to 2 units and novel insertion
        worker(SVDiscoveryTestDataProvider.forSimpleTanDupExpansionWithNovelIns_plus._3(), GATKSVVCFHeaderLines.VCF_ALT_ALLELE_STRING_DUP, 99,
                GATKSVVCFHeaderLines.TANDUP_EXPANSION_ID_START_STRING);

        // tandem dup expansion from 1 unit to 2 units with pseudo-homology
        worker(SVDiscoveryTestDataProvider.forComplexTanDup_1to2_pseudoHom_minus._3(), GATKSVVCFHeaderLines.VCF_ALT_ALLELE_STRING_DUP, 96,
                GATKSVVCFHeaderLines.TANDUP_EXPANSION_ID_START_STRING);

        // tandem dup contraction from 2 units to 1 unit with pseudo-homology
        worker(SVDiscoveryTestDataProvider.forComplexTanDup_2to1_pseudoHom_plus._3(), GATKSVVCFHeaderLines.VCF_ALT_ALLELE_STRING_DEL, -96,
                GATKSVVCFHeaderLines.TANDUP_CONTRACTION_ID_START_STRING);

        // tandem dup contraction from 3 units to 2 units
        worker(SVDiscoveryTestDataProvider.forComplexTanDup_3to2_noPseudoHom_minus._3(), GATKSVVCFHeaderLines.VCF_ALT_ALLELE_STRING_DEL, -96,
                GATKSVVCFHeaderLines.TANDUP_CONTRACTION_ID_START_STRING);

        // tandem dup expansion from 2 units to 3 units
        worker(SVDiscoveryTestDataProvider.forComplexTanDup_2to3_noPseudoHom_plus._3(), GATKSVVCFHeaderLines.VCF_ALT_ALLELE_STRING_DUP, 96,
                GATKSVVCFHeaderLines.TANDUP_EXPANSION_ID_START_STRING);
    }
}
