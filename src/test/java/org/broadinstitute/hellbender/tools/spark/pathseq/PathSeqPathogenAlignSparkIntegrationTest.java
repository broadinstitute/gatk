...
public class PathSeqPathogenAlignSparkIntegrationTest extends CommandLineProgramTest {

    private final String IMAGE_PATH = "src/test/resources/" + PathSeqPathogenAlignSpark.class.getPackage().getName().replace(".", "/") + "/PSFilterUtils/hg19mini.fasta.bwa_image";
    private final String REF_PATH = "src/test/resources/hg19mini.fasta";

    @Override
    public String getTestedClassName() {
        return PathSeqPathogenAlignSpark.class.getSimpleName();
    }
