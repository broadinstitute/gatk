        ...
        return new Object[][]{
                ...
                // CPX
                {
                        new SVCallRecord("var_cpx", "chr1", 1000, null, "chr1", 1000, null,
                                ...
                                Lists.newArrayList(new SVCallRecord.ComplexEventInterval("DUP_chr1:5000-5100"), new SVCallRecord.ComplexEventInterval("DEL_chr2:100-200")),
                                100,
                                SVTestUtils.PESR_ONLY_ALGORITHM_LIST,
                                ALLELES_CPX,
        ...
        return new Object[][]{
                ...
                },
                {
                        SVTestUtils.newVariantContext("var10", "chr1", 1000, 2000,
                                ...
                                GATKSVVCFConstants.StructuralVariantAnnotationType.CPX, SVTestUtils.PESR_ONLY_ALGORITHM_LIST,
                                "chrX", 2000,
                                Map.of("TEST_KEY", "TEST_VAL", GATKSVVCFConstants.CPX_TYPE, GATKSVVCFConstants.ComplexVariantSubtype.dDUP_iDEL.name(), GATKSVVCFConstants.CPX_INTERVALS, "DUP_chr1:100-200,DEL_chr2:300-400"),
                                null),
                        new SVCallRecord("var10", "chr1", 1000, null, "chr1", 2000, null,
                                GATKSVVCFConstants.StructuralVariantAnnotationType.CPX,
                                GATKSVVCFConstants.ComplexVariantSubtype.dDUP_iDEL,
                                Lists.newArrayList(new SVCallRecord.ComplexEventInterval("DUP_chr1:100-200"), new SVCallRecord.ComplexEventInterval("DEL_chr2:300-400")),
                                250,
                                SVTestUtils.PESR_ONLY_ALGORITHM_LIST, ALLELES_CPX, Collections.singletonList(GENOTYPE_CPX_1),
                                TEST_ATTRIBUTES, Collections.emptySet(), null)
                },
                {
                        SVTestUtils.newVariantContext("var11", "chr1", 1000, 1000,
                                ...
                                "chrX", 2000, TEST_ATTRIBUTES, null),
                        new SVCallRecord("var11", "chr1", 1000, true, "chrX", 2000, true, GATKSVVCFConstants.StructuralVariantAnnotationType.CTX, null, Collections.emptyList(), null,
