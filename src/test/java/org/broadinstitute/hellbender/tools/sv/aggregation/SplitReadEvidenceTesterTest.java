...
public class SplitReadEvidenceTesterTest extends GATKBaseTest {
    ...
    private final SVCallRecord TEST_INS_RECORD = new SVCallRecord("call1", "chr21", 1000, true, "chr21", 1000, false, GATKSVVCFConstants.StructuralVariantAnnotationType.INS,
            null, Collections.emptyList(), 500, Collections.singletonList(GATKSVVCFConstants.EvidenceTypes.SR), Collections.singletonList("pesr"), Lists.newArrayList(Allele.REF_N, Allele.SV_SIMPLE_INS), Collections.emptyList(), Collections.emptyMap(), Collections.emptySet(), null, DICTIONARY);
    ...
    private final SVCallRecord TEST_BND_RECORD = new SVCallRecord("call1", "chr21", 1000, true, "chr22", 8000, false, GATKSVVCFConstants.StructuralVariantAnnotationType.BND,
            null, Collections.emptyList(), null, Collections.singletonList(GATKSVVCFConstants.EvidenceTypes.PE), Collections.singletonList("pesr"), Lists.newArrayList(Allele.REF_N, Allele.create("<BND>", false)), Collections.emptyList(), Collections.emptyMap(), Collections.emptySet(), null, DICTIONARY);
    ...
    private final SVCallRecord TEST_INV_RECORD = new SVCallRecord("call1", "chr21", 1000, true, "chr21", 8000, true, GATKSVVCFConstants.StructuralVariantAnnotationType.INV,
            null, Collections.emptyList(), null, Collections.singletonList(GATKSVVCFConstants.EvidenceTypes.PE), Collections.singletonList("pesr"), Lists.newArrayList(Allele.REF_N, Allele.SV_SIMPLE_INV), Collections.emptyList(), Collections.emptyMap(), Collections.emptySet(), null, DICTIONARY);
        ...
        return new Object[][]{
                ...
                // 0 carrier / 1 background sample
                {
                        ...
                        new SplitReadSite("chr21",
                                ...
                                new EvidenceStatUtils.PoissonTestResult(1, 0., 1.))
                },
                // 1 carrier / 0 background sample
                {
                        ...
                        new SplitReadSite("chr21",
                                ...
                                true,
                                Collections.singletonMap("sample1", 1),
                                new EvidenceStatUtils.PoissonTestResult(0.3678794411714422, 1.0, 0.0))
                },
                // 1 carrier / 1 background sample
                {
                        ...
                        new SplitReadSite("chr21",
                                ...
                                true,
                                Collections.singletonMap("sample1", 1),
                                new EvidenceStatUtils.PoissonTestResult(0.3849870989234836, 0.9545454545454546, 0.0))
                },
                // 1 carrier / 1 background sample with evidence
                {
                        ...
                        new SplitReadSite("chr21",
                                ...
                                Lists.newArrayList(new HashMap.SimpleEntry<>("sample1", 1), new HashMap.SimpleEntry<>("sample2", 1)).stream()
                                        .collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue)),
                                new EvidenceStatUtils.PoissonTestResult(0.7524747842595363, 0.9545454545454546, 1.05))
                },
                // 1 carrier / 1 background; multiple loci with evidence
                {
                        ...
                        new SplitReadSite("chr21",
                                ...
                                Lists.newArrayList(new HashMap.SimpleEntry<>("sample1", 6), new HashMap.SimpleEntry<>("sample2", 1)).stream()
                                        .collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue)),
                                new EvidenceStatUtils.PoissonTestResult(0.02190362990370459, 5.727272727272727, 1.05))
                },
        };
    }
    ...
    public void refineSplitReadSiteTest(final List<SplitReadEvidence> sortedEvidence,
        ...
        final SplitReadEvidenceTester tester = new SplitReadEvidenceTester(sampleCoverageMap, MAX_SR_CROSS_DISTANCE, DICTIONARY);
        final SplitReadSite test = tester.testSplitReadSite(sortedEvidence, strand, carrierSamples,
                backgroundSamples, "chr21", defaultPosition);
