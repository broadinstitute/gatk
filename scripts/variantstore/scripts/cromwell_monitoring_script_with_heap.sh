...
# options:
#    "monitoring_script": "gs://bucket/path/to/cromwell_monitoring_script_with_heap.sh"
...
# For this version of the script, I slowed down the sampling rate to once every 30 minutes.  Adjust for your use case
