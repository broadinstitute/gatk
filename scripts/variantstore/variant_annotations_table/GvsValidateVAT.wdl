...
task SubpopulationAlleleNumber {
    ...
    command <<<
        ...
        FROM
          ~{fq_vat_table}
        WHERE
          gvs_all_nc != gvs_afr_an + gvs_amr_an + gvs_eas_an + gvs_eur_an + gvs_mid_an + gvs_oth_an + gvs_sas_an'
...
### TODOs
# AC <= AN for every vid. (gvs_all and gvs_subpop?)
# I assume that you already have automated tests that include proper calculation of AF, don’t count “./.”, etc etc.