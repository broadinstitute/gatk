...
workflow GvsBulkIngestGenomes {
  ...
  call GenerateFOFNsFromDataTables {
    input:
      ...
      workspace_namespace = GetWorkspaceName.workspace_namespace,
      workspace_bucket = GetWorkspaceId.workspace_bucket,
      samples_table_name = select_first([data_table_name, GetColumnNames.data_table]),
      sample_id_column_name = select_first([sample_id_column_name, GetColumnNames.sample_name_column]),
