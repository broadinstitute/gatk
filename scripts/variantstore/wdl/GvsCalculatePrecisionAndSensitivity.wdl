...
workflow GvsCalculatePrecisionAndSensitivity {
  ...
  parameter_meta {
    ...
    input_vcf_fofn: "A FOFN (file of file names) of input VCFs. If empty, `source_submission_id` must be nonempty and contain the UUID of the submission in which the input VCFs can be found."
    source_submission_id: "Submission id of "
...
task Add_AS_MAX_VQS_SCORE_ToVcf {
  input {
    ...
    String docker = "us.gcr.io/broad-dsde-methods/variantstore:2023-07-24-alpine-bd6b9d62e"
    Int cpu = 1
    Int memory_mb = 3500
    Int disk_size_gb = ceil(2*size(input_vcf, "GiB")) + 50
  }
