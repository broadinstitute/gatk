...
workflow GvsCalculatePrecisionAndSensitivity {
  ...
  parameter_meta {
    ...
    chromosomes: "The chromosome(s) on which to analyze precision and sensitivity with RTG tools. The default value for this is `['chr20']`."
...
task Add_AS_MAX_VQS_SCORE_ToVcf {
  input {
    ...
    String docker = "us.gcr.io/broad-dsde-methods/variantstore:2023-06-13-alpine"
    Int cpu = 1
    Int memory_mb = 3500
    Int disk_size_gb = ceil(2*size(input_vcf, "GiB")) + 50
  }
