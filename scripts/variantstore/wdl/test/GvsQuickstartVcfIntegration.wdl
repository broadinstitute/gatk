...
workflow GvsQuickstartVcfIntegration {
    ...
    String effective_parquet_output_gcs_dir =
        select_first([parquet_output_gcs_dir, "~{effective_workspace_bucket}/parquet/by_submission_id/~{effective_submission_id}/~{dataset_suffix}"])
