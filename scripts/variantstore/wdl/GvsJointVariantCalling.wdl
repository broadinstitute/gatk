...
workflow GvsJointVariantCalling {
    ...
    # This is the most updated snapshot of the code as of July 19, 2023
    File gatk_override = "gs://gvs_quickstart_storage/jars/gatk-package-4.2.0.0-737-g728039a-SNAPSHOT-local.jar"
