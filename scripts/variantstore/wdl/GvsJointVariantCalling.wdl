...
workflow GvsJointVariantCalling {
    ...
    # This is the most updated snapshot of the code as of May 11, 2023
    File gatk_override = "gs://gvs_quickstart_storage/jars/gatk-package-4.2.0.0-687-g928ffe9-SNAPSHOT-local.jar"
