...
workflow GvsJointVariantCalling {
    ...
    # This is the most updated snapshot of the code as of May 22, 2023
    File gatk_override = "gs://gvs_quickstart_storage/jars/gatk-package-4.2.0.0-723-g8b4b4c7-SNAPSHOT-local.jar"
