...
task GetToolVersions {
  ...
  output {
    ...
    String variants_docker = "us.gcr.io/broad-dsde-methods/variantstore:2023-10-11-alpine"
    String gatk_docker = "us.gcr.io/broad-dsde-methods/broad-gatk-snapshots:varstore_2023_10_10"
