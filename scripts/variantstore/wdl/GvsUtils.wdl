...
task GetToolVersions {
  ...
  output {
    ...
    String variants_docker = "us-central1-docker.pkg.dev/broad-dsde-methods/gvs/variants:2025-05-23-alpine-98decf79cee2"
...
task GetHailScripts {
    ...
    output {
        ...
        File run_on_hail_cluster_script = "app/run_on_hail_cluster.py"
