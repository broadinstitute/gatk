...
task GetToolVersions {
  ...
  output {
    ...
    String variants_docker = "us-central1-docker.pkg.dev/broad-dsde-methods/gvs/variants:2026-01-13-alpine-6bc952b111d3"
    ...
    String vep_loftee_docker = "us-central1-docker.pkg.dev/broad-dsde-methods/gvs/loftee:2026-01-21-2fee33105f96"
