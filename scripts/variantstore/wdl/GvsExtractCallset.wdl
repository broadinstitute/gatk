...
workflow GvsExtractCallset {
  input {
    ...
    File? gatk_override = "gs://broad-dsp-spec-ops/scratch/bigquery-jointcalling/jars/gg_VS-694_VQSR_Lite_20230208/gatk-package-4.2.0.0-653-gdf96761-SNAPSHOT-local.jar"
