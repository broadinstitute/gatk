...
task ExtractTask {
  ...
  command <<<
    ...
    gatk --java-options "-Xmx9g" \
      ExtractCohort \
        ...
        ~{true='--use-vqsr-classic-scoring true' false='--use-vqsr-classic-scoring false' use_classic_VQSR} \
        ${FILTERING_ARGS} \
  ...
  >>>
  runtime {
    docker: "us.gcr.io/broad-dsde-methods/broad-gatk-snapshots:varstore_2023_05_04_c6d2c7d959057865cdd8cb9d65783aefec97a94c"
    memory: "12 GB"
