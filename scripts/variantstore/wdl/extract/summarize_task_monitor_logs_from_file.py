...
def parse_monitoring_log_files(mlog_file, output_file):
    with open(output_file, 'w') as output, open(mlog_file) as input:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', type=str, help='Monitoring log FOFN', required=True)
