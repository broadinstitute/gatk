...
SUCCEEDED_ASSIGN_IDS_SUBMISSION_ID = '7b74f3e2-82ff-4289-92a5-5a801025a0f5'

SUCCEEDED_ASSIGN_IDS_SUBMISSION = {'cost': 0.018258, 'deleteIntermediateOutputFiles': False, 'memoryRetryMultiplier': 1,
                                   'methodConfigurationName': 'GvsAssignIds',
                                   'methodConfigurationNamespace': 'method-config-namespace', 'status': 'Done',
                                   'submissionDate': '2022-06-13T14:43:57.830Z',
                                   'submissionEntity': {'entityType': 'sample_set', 'entityName': 'gvs_demo_10'},
                                   'submissionId': '7b74f3e2-82ff-4289-92a5-5a801025a0f5',
                                   'submitter': 'gumby@broadinstitute.org', 'useCallCache': False,
                                   'useReferenceDisks': False, 'userComment': '', 'workflows': [{'cost': 0.018258,
                                                                                                 'inputResolutions': [{
                                                                                                     'inputName': 'GvsAssignIds.dataset_name',
                                                                                                     'value': 'vs_441_cost_observability'},
                                                                                                     {
                                                                                                         'inputName': 'GvsAssignIds.external_sample_names',
                                                                                                         'value': [
                                                                                                             'ERS4367795',
                                                                                                             'ERS4367796',
                                                                                                             'ERS4367797',
                                                                                                             ...
                                                                                                             'ERS4367805']},
                                                                                                     {
                                                                                                         'inputName': 'GvsAssignIds.project_id',
                                                                                                         'value': 'gvs-internal'}],
                                                                                                 'messages': [],
                                                                                                 'status': 'Succeeded',
                                                                                                 'statusLastChangedDate': '2022-06-13T15:00:15.195Z',
                                                                                                 'workflowEntity': {
...
SUCCEEDED_ASSIGN_IDS_WORKFLOW = {
    "workflowName": "GvsAssignIds",
    "id": "e3120691-cf45-471d-85d8-a10a8ef51a07",
    "actualWorkflowLanguage": "WDL",
    "actualWorkflowLanguageVersion": "1.0"
}
