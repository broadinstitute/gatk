...
task ExtractAnAcAfFromVCF {
    ...
    command <<<
        ...
        bcftools plugin fill-tags normalized_input.vcf -- -S ~{subpopulation_sample_list} -t AC,AF,AN,AC_het,AC_hom > test.vcf
        ...
        test.vcf | grep -v "*" >> ~{custom_annotations_file_name}
