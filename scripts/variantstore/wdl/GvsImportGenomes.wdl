...
workflow GvsImportGenomes {
  ...
  input {
    ...
    File? load_data_gatk_override = "gs://broad-dsp-spec-ops/scratch/bigquery-jointcalling/jars/gg_VS-637_RespectSampleLoadStatusFinishedFlag_20221012/gatk-package-4.2.0.0-604-gd2e3e65-SNAPSHOT-local.jar"
  }
