...
| billing_project_id     | Optional; Google project ID to charge for the egress of the gVCF file, useful if the bucket(s) the gVCFs are in is requester pays | String  |
