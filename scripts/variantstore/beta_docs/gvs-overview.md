...
| billing_project_id     | Optional; Google project ID to charge for the egress of the GVCF  and index files, useful if the bucket the GVCFs are in has "requester pays" enabled                                                                                                                         | String  |
