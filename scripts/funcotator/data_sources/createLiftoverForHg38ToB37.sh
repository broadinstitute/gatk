...
if ${ISCALLEDBYUSER} ; then
  ...
  awk '{                                  \
    if ( $1 == "chain" ) {                \
      ...
      else if ( $8 ~ /chr11_gl000202_random/ ) {               \
        $8 = "GL000202.1"                        \
      }                                                \
      else if ( $8 ~ /chrUn_gl000244/ ) {               \
        $8 = "GL000244.1"                        \
      }                                                \
      else if ( $8 ~ /chrUn_gl000235/ ) {               \
        $8 = "GL000235.1"                        \
      }                                                \
      else if ( $8 ~ /chrUn_gl000238/ ) {               \
        $8 = "GL000238.1"                        \
      }                                                \
      else if ( $8 ~ /chrUn_gl000226/ ) {               \
        $8 = "GL000226.1"                        \
      }                                                \
      else if ( $8 ~ /chrUn_gl000218/ ) {               \
        $8 = "GL000218.1"                        \
      }                                                \
      else if ( $8 ~ /chrUn_gl000249/ ) {               \
        $8 = "GL000249.1"                        \
      }                                                \
      else if ( $8 ~ /chrUn_gl000242/ ) {               \
        $8 = "GL000242.1"                        \
      }                                                \
      else if ( $8 ~ /chrUn_gl000221/ ) {               \
        $8 = "GL000221.1"                        \
      }                                                \
      else if ( $8 ~ /chr1_gl000192_random/ ) {               \
        $8 = "GL000192.1"                        \
      }                                                \
      else if ( $8 ~ /chrUn_gl000223/ ) {               \
        $8 = "GL000223.1"                        \
      }                                                \
      else if ( $8 ~ /chrUn_gl000232/ ) {               \
        $8 = "GL000232.1"                        \
      }                                                \
      else if ( $8 ~ /chr17_gl000206_random/ ) {               \
        $8 = "GL000206.1"                        \
      }                                                \
      else if ( $8 ~ /chrUn_gl000240/ ) {               \
        $8 = "GL000240.1"                        \
      }                                                \
      else if ( $8 ~ /chrUn_gl000214/ ) {               \
        $8 = "GL000214.1"                        \
      }                                                \
      else if ( $8 ~ /chrUn_gl000212/ ) {               \
        $8 = "GL000212.1"                        \
      }                                                \
      else if ( $8 ~ /chr9_gl000199_random/ ) {               \
        $8 = "GL000199.1"                        \
      }                                                \
      else if ( $8 ~ /chrUn_gl000248/ ) {               \
        $8 = "GL000248.1"                        \
      }                                                \
      else if ( $8 ~ /chr7_gl000195_random/ ) {               \
        $8 = "GL000195.1"                        \
      }                                                \
      else if ( $8 ~ /chrUn_gl000215/ ) {               \
        $8 = "GL000215.1"                        \
      }                                                \
      else if ( $8 ~ /chrUn_gl000225/ ) {               \
        $8 = "GL000225.1"                        \
      }                                                \
      else if ( $8 ~ /chrUn_gl000216/ ) {               \
        $8 = "GL000216.1"                        \
      }                                                \
      else if ( $8 ~ /chr4_gl000194_random/ ) {               \
        $8 = "GL000194.1"                        \
      }                                                \
      else if ( $8 ~ /chrUn_gl000217/ ) {               \
        $8 = "GL000217.1"                        \
      }                                                \
      else if ( $8 ~ /chr8_gl000197_random/ ) {               \
        $8 = "GL000197.1"                        \
      }                                                \
      else if ( $8 ~ /chrUn_gl000222/ ) {               \
        $8 = "GL000222.1"                        \
      }                                                \
      else if ( $8 ~ /chr9_gl000200_random/ ) {               \
        $8 = "GL000200.1"                        \
      }                                                \
      else if ( $8 ~ /chrUn_gl000211/ ) {               \
        $8 = "GL000211.1"                        \
      }                                                \
      else if ( $8 ~ /chrUn_gl000247/ ) {               \
        $8 = "GL000247.1"                        \
      }                                                \
      else if ( $8 ~ /chrUn_gl000233/ ) {               \
        $8 = "GL000233.1"                        \
      }                                                \
      else if ( $8 ~ /chr21_gl000210_random/ ) {               \
        $8 = "GL000210.1"                        \
      }                                                \
      else if ( $8 ~ /chr9_gl000198_random/ ) {               \
        $8 = "GL000198.1"                        \
      }                                                \
      else if ( $8 ~ /chrUn_gl000245/ ) {               \
        $8 = "GL000245.1"                        \
      }                                                \
      else if ( $8 ~ /chrUn_gl000234/ ) {               \
        $8 = "GL000234.1"                        \
      }                                                \
      else if ( $8 ~ /chr17_gl000203_random/ ) {               \
        $8 = "GL000203.1"                        \
      }                                                \
      else if ( $8 ~ /chrUn_gl000239/ ) {               \
        $8 = "GL000239.1"                        \
      }                                                \
      else if ( $8 ~ /chrUn_gl000213/ ) {               \
        $8 = "GL000213.1"                        \
      }                                                \
      else if ( $8 ~ /chrUn_gl000227/ ) {               \
        $8 = "GL000227.1"                        \
      }                                                \
      else if ( $8 ~ /chr19_gl000208_random/ ) {               \
        $8 = "GL000208.1"                        \
      }                                                \
      else if ( $8 ~ /chrUn_gl000230/ ) {               \
        $8 = "GL000230.1"                        \
      }                                                \
      else if ( $8 ~ /chrUn_gl000231/ ) {               \
        $8 = "GL000231.1"                        \
      }                                                \
      else if ( $8 ~ /chrUn_gl000228/ ) {               \
        $8 = "GL000228.1"                        \
      }                                                \
      else if ( $8 ~ /chrUn_gl000243/ ) {               \
        $8 = "GL000243.1"                        \
      }                                                \
      else if ( $8 ~ /chrUn_gl000229/ ) {               \
        $8 = "GL000229.1"                        \
      }                                                \
      else if ( $8 ~ /chr17_gl000205_random/ ) {               \
        $8 = "GL000205.1"                        \
      }                                                \
      else if ( $8 ~ /chrUn_gl000224/ ) {               \
        $8 = "GL000224.1"                        \
      }                                                \
      else if ( $8 ~ /chr1_gl000191_random/ ) {               \
        $8 = "GL000191.1"                        \
      }                                                \
      else if ( $8 ~ /chr8_gl000196_random/ ) {               \
        $8 = "GL000196.1"                        \
      }                                                \
      else if ( $8 ~ /chr4_gl000193_random/ ) {               \
        $8 = "GL000193.1"                        \
      }                                                \
      else if ( $8 ~ /chr9_gl000201_random/ ) {               \
        $8 = "GL000201.1"                        \
      }                                                \
      else if ( $8 ~ /chrUn_gl000237/ ) {               \
        $8 = "GL000237.1"                        \
      }                                                \
      else if ( $8 ~ /chrUn_gl000246/ ) {               \
        $8 = "GL000246.1"                        \
      }                                                \
      else if ( $8 ~ /chrUn_gl000241/ ) {               \
        $8 = "GL000241.1"                        \
      }                                                \
      else if ( $8 ~ /chr17_gl000204_random/ ) {               \
        $8 = "GL000204.1"                        \
      }                                                \
      else if ( $8 ~ /chr18_gl000207_random/ ) {               \
        $8 = "GL000207.1"                        \
      }                                                \
      else if ( $8 ~ /chr19_gl000209_random/ ) {               \
        $8 = "GL000209.1"                        \
      }                                                \
      else if ( $8 ~ /chrUn_gl000219/ ) {               \
        $8 = "GL000219.1"                        \
      }                                                \
      else if ( $8 ~ /chrUn_gl000220/ ) {               \
        $8 = "GL000220.1"                        \
      }                                                \
      else if ( $8 ~ /chrUn_gl000236/ ) {               \
        $8 = "GL000236.1"                        \
      }                                               \
      else if ( $8 ~ /chr6_qbl_hap6/ ) {               \
        $8 = $8                                         \
      }                                                \
      else if ( $8 ~ /chr6_cox_hap2/ ) {               \
        $8 = $8                                         \
      }                                                \
      else if ( $8 ~ /chr6_dbb_hap3/ ) {               \
        $8 = $8                                         \
      }                                                \
      else if ( $8 ~ /chr6_ssto_hap7/ ) {               \
        $8 = $8                                         \
      }                                                \
      else if ( $8 ~ /chr6_mann_hap4/ ) {               \
        $8 = $8                                         \
      }                                                \
      else if ( $8 ~ /chr17_ctg5_hap1/ ) {               \
        $8 = $8                                         \
      }                                                \
      else if ( $8 ~ /chr6_mcf_hap5/ ) {               \
        $8 = $8                                         \
      }                                                \
      else if ( $8 ~ /chr4_ctg9_hap1/ ) {               \
        $8 = $8                                         \
      }                                                \
      else if ( $8 ~ /chr6_apd_hap1/ ) {               \
        $8 = $8                                         \
      }                                                \
			else if ( $8 ~ /^chr[0123456789XY]*/ ) {           \
      	$8 = substr($8,4)                                  \
			}                                   \
    }                                     \
    ; print                               \
