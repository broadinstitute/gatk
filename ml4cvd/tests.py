...
class TestTrainingModels(unittest.TestCase):
    ...
    def test_train_categorical_mlp(self):
        ...
        args.output_tensors = [
            'coronary_artery_disease_soft', 'diabetes_type_2',
        ...
        expected = {
            'no_coronary_artery_disease_soft': 0.4945240833284755, 'coronary_artery_disease_soft': 0.4945240833284755,
...
class TestPretrainedModels(unittest.TestCase):
    def test_ecg_regress(self):
        ...
        args.output_tensors = [
            'p-axis', 'p-duration', 'p-offset', 'p-onset', 'pp-interval', 'pq-interval', 'q-offset', 'q-onset', 'qrs-complexes',
        ...
        expected = {
            'PAxis_pearson': 0.6010829310005574, 'PDuration_pearson': 0.334397562979115, 'POffset_pearson': 0.8870224086564694,
    ...
    def test_ecg_rhythm(self):
        ...
        print('expected = ', performances)
        expected = {
            'Normal_sinus_rhythm': 0.9824029566392662, 'Sinus_bradycardia': 0.9918234160230809, 'Marked_sinus_bradycardia': 0.9975368393759994,
